package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_730:Number = 64;
      
      public static const const_1163:Number = 32;
      ...
      private var var_1949:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_546 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1244 = new Vector3d();
         this.var_1949 = 1;
         this.var_1952 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
      ...
      {
         this.var_1950.assign(this.var_153);
         return this.var_1950;
      }
      
      public function get location() : IVector3d
      {
         this.var_546.assign(this.var_95);
         this.var_546.x *= this.var_454;
         this.var_546.y *= this.var_452;
         this.var_546.z *= this.var_453;
         return this.var_546;
      }
      ...
      {
         if(this.var_454 != param1 * this.var_1949)
         {
            this.var_454 = param1 * this.var_1949;
            ++this.var_169;
         }
      }
      ...
      {
         if(this.var_452 != param1 * this.var_1952)
         {
            this.var_452 = param1 * this.var_1952;
            ++this.var_169;
         }
      }
      ...
      {
         if(this.var_453 != param1 * this.var_1951)
         {
            this.var_453 = param1 * this.var_1951;
            ++this.var_169;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_95.x /= this.var_454;
         this.var_95.y /= this.var_452;
         this.var_95.z /= this.var_453;
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1244.assign(_loc22_);
         }
         else
         {
            this.var_1244.assign(_loc17_);
         }
         ++this.var_169;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_454;
         _loc2_.y *= this.var_452;
         _loc2_.z *= this.var_453;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1244);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_452;
            _loc2_.z *= this.var_453;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1244);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_95.x * this.var_454,this.var_95.y * this.var_452,this.var_95.z * this.var_453);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_153;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_454,param2.y * this.var_452,param2.z * this.var_453);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_454,param3.y * this.var_452,param3.z * this.var_453);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_454,param4.y * this.var_452,param4.z * this.var_453);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1163;
         }
         else
         {
            this.scale = const_730;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_730;
      }
