package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_341:int = 50;
      
      private static const const_1295:int = 50;
      
      private static const const_950:Number = 60;
      
      private static const const_1296:Number = 50;
      ...
      private var var_128:Sprite;
      
      private var var_97:Sprite;
      
      private var var_579:Map;
      
      private var var_481:Point;
      ...
      private var var_1341:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2173:Number = -1.0E7;
      
      private var var_2177:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_243.addChild(this.var_97);
         ...
         this.var_242 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
      ...
      {
         this.var_481.x -= param1 - this.var_577;
         this.var_577 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_481.y -= param1 - this.var_580;
         this.var_580 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1036 = true;
            if(this.var_128 != null && !this.var_243.contains(this.var_128))
            {
               this.var_243.addChild(this.var_128);
               this.var_97.mask = this.var_128;
            }
         }
         else if(!param1 && this.var_1036)
         {
            ...
            if(this.var_128 != null && this.var_243.contains(this.var_128))
            {
               this.var_243.removeChild(this.var_128);
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_128 != null)
         {
            this.var_128.graphics.clear();
         }
         else
         {
            this.var_128 = new Sprite();
            this.var_128.name = "mask";
            if(this.var_1036)
            {
               this.var_243.addChild(this.var_128);
               this.var_97.mask = this.var_128;
         ...
         this.var_128.graphics.beginFill(0);
         this.var_128.graphics.drawRect(0,0,param1,param2);
         this.var_712 = param1;
         this.var_709 = param2;
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_712 != this.var_2176 || this.var_709 != this.var_2174)
         {
            _loc8_ = true;
         }
         if(this.var_97.x != this.var_577 || this.var_97.y != this.var_580)
         {
            this.var_97.x = this.var_577;
            this.var_97.y = this.var_580;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_480.sortOn("z",0 | 0);
         if(_loc5_ < this.var_480.length)
         {
            this.var_480.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_480[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2176 = this.var_712;
         this.var_2174 = this.var_709;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1342 > 0)
         {
            ...
            if(_loc2_ > const_950 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2175 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_711;
               if(this.var_711 == const_341 + 1)
               {
                  this.var_490 = _loc2_;
                  this.var_1615 = this.var_2172;
               }
               else if(this.var_711 > const_341 + 1)
               {
                  _loc3_ = Number(this.var_711 - const_341);
                  this.var_490 = this.var_490 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1615 = this.var_1615 * (_loc3_ - 1) / _loc3_ + Number(this.var_2172) / _loc3_;
                  if(this.var_711 > const_341 + const_1295)
                  {
                     this.var_711 = const_341;
                     if(!this.var_1078 && this.var_490 > const_950)
                     {
                        this.var_1078 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1078 && this.var_490 < const_1296)
                     {
                        this.var_1078 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1613 && this.var_1078);
         ...
         _loc13_ += int(this.var_712 / 2);
         _loc14_ += int(this.var_709 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_577;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_580;
                  if(_loc19_ < this.var_712 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this.var_709 && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_480.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_577;
                     _loc17_.y = _loc20_ - this.var_580;
      ...
      {
         if(param1 < 0 || param1 >= this.var_871)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= this.var_871)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_710 || this.var_710 == 0)
         {
            _loc4_ = this.var_871 - 1;
            while(_loc4_ >= param1)
            {
      ...
      {
         if(param1 < 0 || param1 >= this.var_480.length)
         {
            return null;
         }
         return this.var_480[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_242.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_242.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_242.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_872.identity();
            this.var_872.scale(-1,1);
            this.var_872.translate(data.width,0);
            finalData.draw(data,this.var_872);
            if(name.length > 0)
            {
               this.var_242.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_640);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_873.redMultiplier = tR;
            this.var_873.greenMultiplier = tG;
            this.var_873.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_873);
            if(name.length > 0)
            {
               this.var_242.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_577;
         param2 -= this.var_580;
         this.var_481.x = param1;
         this.var_481.y = param2;
         if(this.var_1079 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1612;
         }
         this.var_1612 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1079;
         return this.var_1612;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_712 / 2;
         var _loc12_:Number = param2 - this.var_709 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1614,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2173 || param2 != this.var_2177)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      {
         if(this.var_343 != null && param1 != null)
         {
            this.var_343.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_343 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_343.getKey(_loc1_);
            _loc3_ = this.var_343.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1341.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1079 == 0)
         {
            this.checkMouseHits(this.var_481.x,this.var_481.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1079 = 0;
         ++this.var_1614;
      }
