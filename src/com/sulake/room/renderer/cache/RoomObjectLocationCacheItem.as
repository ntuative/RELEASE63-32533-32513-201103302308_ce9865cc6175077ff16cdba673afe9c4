package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1658 || param1.getUpdateID() != this.var_2244)
         {
            this.var_2244 = param1.getUpdateID();
            if(param2.updateId != this.var_1658 || _loc4_.x != this.var_1093.x || _loc4_.y != this.var_1093.y || _loc4_.z != this.var_1093.z)
            {
               this.var_1658 = param2.updateId;
               this.var_1093.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2245 = _loc3_;
         if(_loc3_)
         {
