package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1368:int = 128;
      
      private var var_1369:Boolean = false;
      
      private var var_2889:Point;
      ...
      {
         if(param1 != this.var_1657 || param2 != this.var_1656)
         {
      ...
      {
         if(this.var_1368 > 255 || bitmapData == null)
         {
            return false;
         }
