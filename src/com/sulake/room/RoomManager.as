package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_648:IRoomObjectFactory = null;
      
      private var var_522:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1179:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_592,this.onContentLoaded);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_648 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_648 == null || this.var_522 == null)
         {
            return;
         }
         this._state = const_1523;
         if(this.var_1179 != null)
         {
            _loc1_ = this.var_1179;
            this.var_1179 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_649.indexOf(_loc5_) < 0)
            {
               this.var_57.loadObjectContent(_loc5_,events);
               this.var_649.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_601.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_601[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_648.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_648 != null)
         {
            return this.var_648.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_57.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_649.indexOf(param1);
            if(_loc2_ >= 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_57 == null || this.var_522 == null)
         {
            return;
         }
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_648.createRoomObjectLogic(_loc6_);
