package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1430:String = "asset-libraries";
      
      private static const const_1432:String = "library";
      
      private static const const_1433:String = "service-libraries";
      ...
      private static const const_1429:String = "error_data";
      
      private static const const_1435:String = "error_cat";
      
      private static const const_1427:String = "error_desc";
       
      
      private var var_393:LibraryLoaderQueue;
      
      private var var_828:IEventDispatcher;
      
      private var var_551:uint;
      
      private var var_394:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1214:
               ...
               this.var_394 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_762:
               debug("Core; using complex frame update handler");
               this.var_394 = this.complexFrameUpdateHandler;
               break;
            case Core.const_769:
               debug("Core; using profiler frame update handler");
               this.var_394 = this.profilerFrameUpdateHandler;
               this.var_212 = new Profiler(this);
               attachComponent(this.var_212,[new IIDProfiler()]);
               var_404.addChild(new ProfilerViewer(this.var_212));
               break;
            case Core.const_513:
               debug("Core; using experimental frame update handler");
               this.var_394 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_394 = this.debugFrameUpdateHandler;
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_279[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1429,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1435,String(param3));
         ErrorReportStorage.setParameter(const_1427,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_828 = loadingEventDelegate;
         if(this.var_393 == null)
         {
            this.var_393 = new LibraryLoaderQueue(_debug);
         }
         try
         {
            node = config.child(const_1430)[0];
            if(node != null)
            {
               list = node.child(const_1432);
         ...
         try
         {
            node = config.child(const_1433)[0];
            if(node != null)
            {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_828)
         {
            this.var_828.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_828)
         {
            ...
            this.var_828.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_828)
                  {
                     this.var_828.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_551 - this.var_393.length,this.var_551,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_212 ? 0 : this.var_1546 & 0;
         if(_loc3_ == Core.const_513)
         {
            this.var_279[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_279[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_212 ? 0 : this.var_1546 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_102)
         {
            _loc3_ = this.var_279[_loc5_] as Array;
            if(_loc4_ == Core.const_513)
            {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_394(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_678[priority] = 0;
            receivers = this.var_279[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_102)
         {
            ...
            {
               if(this.var_678[priority] < priority)
               {
                  ++this.var_678[priority];
                  skip = true;
               }
            }
            if(!skip)
