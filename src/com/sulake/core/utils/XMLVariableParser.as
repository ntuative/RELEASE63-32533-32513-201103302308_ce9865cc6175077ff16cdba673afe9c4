package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1520:String = "float";
      
      public static const const_37:String = "Boolean";
      
      public static const const_1561:String = "bool";
      ...
      private static const const_627:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_626:String = "value";
      
      private static const const_607:String = "HabboUserDefinedRoomEventsCom_move_vrt_png";
      
      private static const const_1782:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_627));
         }
         else
         {
            _loc4_ = param1.child(const_627)[0];
         }
         ...
         _loc7_ = param1.attribute(const_626);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_626));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_626)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_247 || _loc5_ == const_138)
            {
