package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1754:uint = 1;
      
      protected static const const_1755:uint = 2;
      
      protected static const const_1757:uint = 4;
      ...
      public static const const_1066:Boolean = false;
      ...
      protected var var_1059:Boolean = false;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1066)
         {
            ...
            while(var_838.length < const_1636 && false)
            {
      ...
      {
         return !!this.var_1059 ? uint(this.var_1320 - this.var_2107) : uint(getTimer() - this.var_2107);
      }
      ...
      {
         if(this.var_1060 && !_disposed)
         {
            this.var_1060 = false;
            if(!this.var_1059 && this.var_240)
            {
               this.var_1320 = -1;
               this.var_2107 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1059 && !_disposed && this.var_1319 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_240,const_1646 - this.var_1319);
            if(this.var_2877)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_474 == LibraryLoader.const_1756)
         {
