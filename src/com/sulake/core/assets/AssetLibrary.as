package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1031:String = "AssetLibraryReady";
      
      public static const const_698:String = "AssetLibraryLoaded";
      
      public static const const_1746:String = "AssetLibraryUnloaded";
      
      public static const const_1717:String = "AssetLibraryLoadError";
      
      private static const const_425:String = "name";
      
      private static const const_960:String = "asset";
      
      private static const const_959:String = "param";
      ...
      private static var var_1687:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_497:uint = 0;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_497;
         this.var_420 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_594 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_961);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_425);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_959);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_594 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_594 == param1.url && this.var_900)
         {
            if(!this.var_897 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_595);
            }
            this.var_897 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1031));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_900 = false;
         this.var_594 = null;
         dispatchEvent(new Event(AssetLibrary.const_1746));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_898[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1032,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_422;
                     this.var_421.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_421.length ? this.getAssetByName(this.var_421[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_155)
         {
            ...
            {
               return this.var_421.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_155[param1] != null || (this.var_595 != null ? this.var_595[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1687.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_155)
            {
               if(this.var_155[_loc2_] == param1)
               {
                  this.var_421.splice(this.var_421.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_420.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_420[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_420[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_420)
         {
            _loc3_ = AssetTypeDeclaration(this.var_420[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_420)
         {
            _loc4_ = AssetTypeDeclaration(this.var_420[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1717));
         this.var_42 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_961);
         if(_loc2_ == null)
         {
