package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1589:int = 10000;
      ...
      private var var_1089:IEncryption;
      
      private var var_721:IProtocol;
      
      private var _id:String;
      
      private var var_1088:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1088 = new MessageClassManager();
         this.var_80 = new Socket();
         this.var_348 = new Timer(const_1589,1);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1088.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         {
            _loc3_ = this.var_1089.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1088.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1089 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_721.getMessages(this.var_489,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1088.getMessageEventClasses(id);
               events = new Array();
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_489.writeByte(this.var_80.readUnsignedByte());
         }
      }
