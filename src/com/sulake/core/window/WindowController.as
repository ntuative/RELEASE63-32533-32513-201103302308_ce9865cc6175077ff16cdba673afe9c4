package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1220:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1270:String = "_COLORIZE";
      
      protected static const const_1750:String = "_IGNORE_INHERITED_STYLE";
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_765 = _loc13_.blend;
            var_469 = _loc13_.var_2853;
            if(var_468 != _loc13_.background)
            {
      ...
      {
         var_468 = param1;
         var_238 = !!var_468 ? uint(var_238 | var_562) : uint(var_238 & 16777215);
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_238 = !!var_468 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.REDRAW);
      }
      ...
      {
         var_562 = param1 << 24;
         var_238 = !!var_468 ? uint(var_562 | var_238) : uint(16777215 & var_238);
         _context.invalidate(this,var_11,WindowRedrawFlag.REDRAW);
      }
      
      public function set blend(param1:Number) : void
      {
         var_765 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      {
         var_469 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_590,this,null);
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_83 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_520,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set clipping(param1:Boolean) : void
      {
         ...
         {
            var_687 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_497,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_575,this,this._parent);
            ...
            else
            {
               ...
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1096,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_83,var_19,_context,var_11,null,this.var_693,this.properties,var_852.concat(),_id) as WindowController;
         _loc2_.var_469 = var_469;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2715 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_571)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_19 & 0);
            if(_loc7_ == WindowParam.const_489)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1259,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_865,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_589,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_188,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
         }
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_42:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1250;
                  if(testParamFlag(WindowParam.const_365))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_245))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_188:
                  ...
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_532,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(testParamFlag(WindowParam.const_177,WindowParam.const_163))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_208,WindowParam.const_167))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        var_19 = _loc10_;
                        _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_304,this._parent,this);
               ...
               case WindowNotifyEvent.const_589:
                  _context.invalidate(this,var_11.union(var_63),WindowRedrawFlag.const_577);
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1094,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
                        _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_311,this._parent,this);
                        this._parent.update(this,_loc6_);
                        _loc6_.recycle();
                     }
                  }
               ...
               case WindowNotifyEvent.const_391:
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_711,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_590:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_1263);
                  break;
               case WindowNotifyEvent.const_520:
                  ...
                  while(--_loc8_ > -1)
                  {
                     ...
                     if(_loc9_.tags.indexOf(const_1750) == -1)
                     {
                        _loc9_.style = var_83;
                     }
                  }
               ...
               case WindowNotifyEvent.const_497:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_577);
                     }
                  }
                  else if(var_19 & 0)
                  {
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1187:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1537:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1590:
               _loc2_ = "null";
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_469);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_469);
      }
      ...
      public function setStateFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_state != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_590,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_83 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_520,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_19 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_497,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_150,WindowParam.const_163);
         var _loc2_:* = !testParamFlag(WindowParam.const_148,WindowParam.const_167);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_420)
               {
                  _loc3_.x += _loc4_;
               }
      ...
      public function destroy() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1156,this,null);
         ...
         _loc1_.type = WindowNotifyEvent.const_1043;
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1105,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function maximize() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_70,true);
         _loc1_.type = WindowNotifyEvent.const_1236;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1155,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      {
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1175,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.type = WindowNotifyEvent.const_391;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1211,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1071,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         this.setStateFlag(WindowState.const_70,false);
         _loc1_.type = WindowNotifyEvent.const_1253;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_746;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1217,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1221 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_387,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1221 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_387,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_798,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
