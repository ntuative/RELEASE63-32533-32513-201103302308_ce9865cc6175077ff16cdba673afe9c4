package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_854:Dictionary;
      
      protected var var_855:Dictionary;
      
      private var var_887:Matrix;
      
      public function BitmapSkinRenderer(param1:String)
      {
         super(param1);
         this.var_854 = new Dictionary(false);
         this.var_855 = new Dictionary(false);
         this.var_887 = new Matrix();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               _loc2_ = this.var_854[_loc1_] as BitmapData;
               _loc2_.dispose();
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_501)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_323)
                  {
                     _loc12_ = true;
                     var_33.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_501)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_323)
                  {
                     _loc13_ = true;
                     var_33.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_323 || _loc10_.scaleH == SkinLayoutEntity.const_323)
                  {
                  ...
                  {
                     this.var_887.a = 0 / _loc17_.width;
                     this.var_887.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_33.width,var_33.height,false);
                     _loc30_.draw(_loc17_,this.var_887);
                     _loc31_ = new BitmapData(var_33.width,var_33.height,true,0);
                     _loc31_.draw(_loc18_,this.var_887,null);
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_854[_loc3_];
         if(_loc4_ == null)
         {
