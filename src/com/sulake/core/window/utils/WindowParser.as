package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1199:String = "_EXCLUDE";
      
      public static const const_1824:String = "_INCLUDE";
      
      public static const const_1841:String = "_TEMP";
      
      private static const const_1275:String = "layout";
      
      private static const const_948:String = "window";
      
      private static const const_946:String = "variables";
      
      private static const const_947:String = "filters";
      
      private static const const_425:String = "name";
      
      private static const const_1286:String = "style";
      
      private static const const_606:String = "params";
      
      private static const const_1277:String = "tags";
      ...
      private static const const_1273:String = "visible";
      
      private static const const_1279:String = "caption";
      ...
      private static const const_1284:String = "children";
      
      private static const const_1272:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1278:String = "height_min";
      
      private static const const_1274:String = "height_max";
      
      private static const const_607:String = "HabboUserDefinedRoomEventsCom_move_vrt_png";
      
      private static const const_159:String = "0";
      
      private static const const_1285:String = "$";
      
      private static const const_1281:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1283:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1282:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1304:Dictionary;
      
      protected var var_1303:Dictionary;
      
      protected var var_1050:Dictionary;
      
      protected var var_1573:Dictionary;
      
      protected var var_2085:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1303 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1304,this.var_1303);
         this.var_1050 = new Dictionary();
         this.var_1573 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1050,this.var_1573);
         this.var_2085 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1282,const_50);
         return param1.replace(const_1283,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1304)
            {
               delete this.var_1304[_loc1_];
            }
            for(_loc1_ in this.var_1303)
            {
               delete this.var_1303[_loc1_];
            }
            for(_loc1_ in this.var_1050)
            {
               delete this.var_1050[_loc1_];
            }
            for(_loc1_ in this.var_1573)
            {
               delete this.var_1573[_loc1_];
            }
            this.var_2085.dispose();
            this.var_2085 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1275)
         {
            _loc8_ = param1.child(const_946);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_947).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1304[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_425,variables,"")));
         style = uint(this.parseAttribute(xml,const_1286,variables,style));
         params = uint(this.parseAttribute(xml,const_606,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1277,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_159));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_159));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_159));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_159));
         visible = this.parseAttribute(xml,const_1273,variables,visible.toString()) == const_607;
         ...
         if(xml.child(const_606).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_425,variables,"") as String;
               if(this.var_1050[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_425)) + "\"!");
               }
               params |= this.var_1050[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1279,variables,caption)));
         if(tag != const_50)
         {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_946)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1272,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1278,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1274,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_607;
         blend = Number(this.parseAttribute(xml,const_1225,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1276,variables,window.clipping.toString()) == const_607;
         ...
         list = xml.child(const_947).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1303[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1199) == -1)
                  {
