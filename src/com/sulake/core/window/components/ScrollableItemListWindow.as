package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1118:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_428)
         {
            this.var_428.removeEventListener(WindowEvent.const_305,this.scrollBarEventProc);
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1118)
         {
            this.var_1118 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_428)
         {
            ...
            if(this.var_428)
            {
               this.var_428.addEventListener(WindowEvent.const_305,this.scrollBarEventProc);
