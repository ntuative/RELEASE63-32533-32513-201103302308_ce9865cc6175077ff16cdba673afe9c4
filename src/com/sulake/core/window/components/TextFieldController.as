package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1574:uint = 500;
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_840 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_396,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_779,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1638);
         _loc1_.push(this.var_1317 != PropertyDefaults.const_1085 ? new PropertyStruct(PropertyDefaults.const_643,this.var_1317,PropertyStruct.const_37,true) : PropertyDefaults.const_1723);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1248 ? new PropertyStruct(PropertyDefaults.const_917,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1569);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1049 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1611);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_643:
                  this.var_1317 = _loc2_.value as Boolean;
                  if(this.var_1317)
                  {
               ...
               case PropertyDefaults.const_779:
                  ...
                  break;
               case PropertyDefaults.const_1027:
