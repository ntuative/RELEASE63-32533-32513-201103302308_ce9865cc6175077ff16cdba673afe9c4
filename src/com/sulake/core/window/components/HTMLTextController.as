package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_896:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_895:String = "SetActivatedBadgesComposer";
      
      private var var_1100:String = null;
      
      private var var_1680:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1100 == param2)
         {
            return;
         }
         param1.var_1100 = param2;
         param1.var_1680 = null;
         if(param1.var_1100 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1100);
            param1.var_1680 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_703.indexOf(param1) > -1)
         {
            this.var_895 = param1;
         }
      }
      ...
      {
         return this.var_895 == LinkTarget.const_32 ? defaultLinkTarget : this.var_895;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1680;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_884)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_895 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_692,this.var_895,PropertyStruct.const_54,true,PropertyDefaults.const_703));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1549);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_692)
            {
