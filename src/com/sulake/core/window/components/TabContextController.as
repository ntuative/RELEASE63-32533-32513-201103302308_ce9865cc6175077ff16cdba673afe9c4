package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_1054:ITabSelectorWindow;
      
      protected var var_2098:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1054 = findChildByTag(const_1355) as ITabSelectorWindow;
            if(this.var_1054 != null)
            {
               this.var_1054.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2098 = findChildByTag(const_1354) as IWindowContainer;
         }
      ...
      {
         return !!this.var_840 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1054.numSelectables;
      }
