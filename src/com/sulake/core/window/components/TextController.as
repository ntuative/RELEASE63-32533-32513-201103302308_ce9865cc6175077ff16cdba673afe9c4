package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1271:Dictionary = createPropertySetterTable();
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_465,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_465 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_465,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_882 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_861 * this.maxScrollH,this.var_568 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1184) ? new PropertyStruct(PropertyDefaults.const_647,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1230) : PropertyDefaults.const_1551);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1082 ? new PropertyStruct(PropertyDefaults.const_831,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1266) : PropertyDefaults.const_1522);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1174 ? new PropertyStruct(PropertyDefaults.const_1132,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1063) : PropertyDefaults.const_1501);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_855) ? new PropertyStruct(PropertyDefaults.const_373,this._field.textColor,PropertyStruct.const_156,true) : PropertyDefaults.const_1157);
         ...
         _loc1_.push(this.var_39.left != PropertyDefaults.const_719 ? new PropertyStruct(PropertyDefaults.const_258,this.var_39.left,PropertyStruct.const_41,true) : PropertyDefaults.const_549);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_669 ? new PropertyStruct(PropertyDefaults.const_257,this.var_39.top,PropertyStruct.const_41,true) : PropertyDefaults.const_576);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_885 ? new PropertyStruct(PropertyDefaults.const_249,this.var_39.right,PropertyStruct.const_41,true) : PropertyDefaults.const_539);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_873 ? new PropertyStruct(PropertyDefaults.const_241,this.var_39.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_573);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1068 ? new PropertyStruct(PropertyDefaults.const_839,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1716);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_263,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_263,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_263,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
