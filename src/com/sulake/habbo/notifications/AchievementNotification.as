package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1781:String = "badge_bg_001_png";
      
      private const const_2064:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this.var_2541 = this.var_69.getBadgeName(this.var_311);
         this.var_2545 = this.var_69.getBadgeDesc(this.var_311);
         this.var_2542 = this.var_69.getAchievementNameForFacebook(this.var_311,this.var_303.userName,this.var_303.realName,this.var_1463);
         this.var_2544 = this.var_69.getAchievementDescForFacebook(this.var_311,this.var_303.userName,this.var_303.realName,this.var_1463);
         ...
         this.var_69.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1789.toString());
         this.var_69.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1462.toString());
         this.var_69.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1462.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1819;
         var _loc17_:String = this.var_1819 == 0 ? "pixels" : "activitypoints";
         this.var_69.registerParameter(_loc16_,_loc17_,"" + this.var_2546);
         _loc15_.caption = this.var_69.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1781);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2064) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_69.registerParameter(param1,"badge_name",this.var_2541);
         this.var_69.registerParameter(param1,"badge_desc",this.var_2545);
         this.var_69.registerParameter(param1,"badge_name_fb",this.var_2542);
         this.var_69.registerParameter(param1,"badge_desc_fb",this.var_2544);
         this.var_69.registerParameter(param1,"level",this.var_1463.toString());
         this.var_69.registerParameter(param1,"name",this.var_303.userName);
         return this.var_69.registerParameter(param1,"realname",this.var_303.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_303.events.removeEventListener(BadgeImageReadyEvent.const_154,this.onBadgeImageReady);
            this.var_303 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1781);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_311,this._feedTitleFb,this.var_2543,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2540));
