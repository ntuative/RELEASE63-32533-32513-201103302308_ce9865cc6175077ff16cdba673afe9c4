package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1806:String = "no_reqs_info";
      ...
      {
         this.var_1975 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1974 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1974.procedure = this.onDismissAllButtonClick;
         this.var_1975.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_354)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_1129)
         {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_354;
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_399 && _loc4_.state != FriendRequest.const_354)
            {
               _loc4_.state = FriendRequest.const_354;
