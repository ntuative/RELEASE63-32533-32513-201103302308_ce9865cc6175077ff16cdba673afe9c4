package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_224.length / const_402);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_968 * const_402;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_968 + 1) * const_402,this.var_224.length);
      }
