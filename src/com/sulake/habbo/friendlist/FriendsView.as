package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2575:IContainerButtonWindow;
      
      private var var_2574:IContainerButtonWindow;
      
      private var var_2572:IContainerButtonWindow;
      
      private var var_2573:IContainerButtonWindow;
      ...
      {
         this.var_2575 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2574 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2572 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2573 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2575,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2574,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2572,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2573,this.isEnableRemoveButton(_loc1_));
      }
