package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private function prepare() : void
      {
         ...
         this.var_911 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_278 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1351.prepare(this.var_911);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1197,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1072,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_742,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_663,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_742,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_663,true);
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1631 == -1 ? 0 : int(this.var_16.height - this.var_1631);
         var _loc4_:int = this.var_1633 == -1 ? 0 : int(this.var_16.width - this.var_1633);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_742,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1197,false);
         ...
         this.var_1631 = this.var_16.height;
         this.var_1633 = this.var_16.width;
