package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_785:ISessionDataManager;
      
      private var var_2647:FriendListLookAndFeel;
      
      private var var_436:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1861:OpenedToWebPopup;
      ...
      private var var_1862:AvatarSearchResults;
      ...
      {
         this.var_2647 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_102 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1862 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_651.stop();
            this.var_651.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_651 = null;
         }
         ...
         if(this.var_1163)
         {
            this.var_1163.release(new IIDAvatarRenderManager());
            this.var_1163 = null;
         }
         ...
         if(this.var_785)
         {
            this.var_785.release(new IIDSessionDataManager());
            this.var_785 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1861 = new OpenedToWebPopup(this);
         }
         this.var_1861.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_372.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:IAvatarImage = this.var_1163.createAvatarImage(param1,AvatarScaleType.const_93,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "HabboUserDefinedRoomEventsCom_move_vrt_png";
      }
      ...
      {
         this.var_785 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_372 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_102.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_1044,this.getText("friendlist.friends")));
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_352,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_651)
         {
            this.var_651 = new Timer(120000);
            this.var_651.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_651.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_102.findCategory(FriendCategory.const_352);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_436.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_370));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_372.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_372.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_436.findTab(FriendListTab.const_101).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_372.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_436.findTab(FriendListTab.const_101);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1862.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_436.findTab(FriendListTab.const_101);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_785 || !this.var_372)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_785.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_45))
         {
            _loc2_ = this.var_372.vipLimit;
         }
         else if(this.var_785.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_372.clubLimit;
         }
         if(_loc2_ > this.var_372.limit)
         {
            this.var_372.limit = _loc2_;
         }
      }
