package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_787 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_787.procedure = this.onSearchInput;
         this.var_787.addEventListener(WindowKeyboardEvent.const_190,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_62.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_386,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_787.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_787.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_787.text;
