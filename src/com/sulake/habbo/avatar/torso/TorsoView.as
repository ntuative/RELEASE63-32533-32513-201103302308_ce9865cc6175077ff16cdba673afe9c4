   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_68,FigureData.const_252,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_68,FigureData.const_201,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_68,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_68,FigureData.const_234,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_68 && var_150 == "")
         {
            var_68.switchCategory(FigureData.const_201);
         }
      }
