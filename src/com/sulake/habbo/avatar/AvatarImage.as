package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1314:String = "Default";
      
      private static const const_1313:int = 2;
      
      private static const const_1315:String = AvatarSetType.const_36;
      ...
      protected var var_1669:int;
      
      protected var var_285:IActiveActionData;
      
      protected var var_753:Boolean;
      ...
      protected var var_564:IAvatarDataContainer;
      
      protected var var_334:Array;
      
      protected var var_45:BitmapData;
      
      private var var_1023:IActiveActionData;
      ...
      private var var_2261:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1315,const_1313);
         this.var_334 = new Array();
         this.var_1023 = new ActiveActionData(AvatarAction.const_359);
         this.var_1023.definition = this._structure.getActionDefinition(const_1314);
         this.resetActions();
      ...
      {
         param2 += this.var_1671;
         if(param2 < AvatarDirectionAngle.const_1215)
         {
            param2 = AvatarDirectionAngle.const_340 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_340)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_591,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_244.length == 1 && this.var_90 == this.var_1669)
         {
            return this.var_90 + this.var_493 + this.var_591 % 4;
         }
         if(this.var_244.length == 2)
         {
            for each(_loc1_ in this.var_244)
            {
               ...
               {
                  return this.var_90 + this.var_493 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_591 % 11;
                  return this.var_90 + "_" + this.var_1669 + this.var_493 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2263 || param2 != this.var_2261 || param1 != this.var_2262)
         {
            this.var_2263 = param3;
            this.var_2261 = param2;
            this.var_2262 = param1;
            this.var_1670 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1313 || this.var_45 == null || (this.var_45.width != _loc5_.width || this.var_45.height != _loc5_.height))
         {
            if(this.var_45 != null && !this.var_1313)
            {
               this.var_45.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_591);
         ...
         {
            if(this.var_564.paletteIsGrayscale)
            {
               ...
               this.var_45 = _loc13_;
               this.var_45.paletteMap(this.var_45,this.var_45.rect,new Point(0,0),this.var_564.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_591);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_334.push(new ActiveActionData(param1,param2,this.var_591));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_285 = this.var_1023;
         this.var_285.definition = this.var_1023.definition;
         this.resetBodyPartCache(this.var_1023);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_493 = "";
         this.var_244 = this._structure.sortActions(this.var_334);
         if(this.var_244 == null)
         {
            this.var_771 = new Array(0,0,0);
            if(this.var_1382 != "")
            {
               _loc1_ = true;
               this.var_1382 = "";
         ...
         {
            this.var_771 = this._structure.getCanvasOffsets(this.var_244,this._scale,this.var_90);
            for each(_loc4_ in this.var_244)
            {
               this.var_493 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_307)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1381 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1381 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1382 != this.var_493)
            {
               _loc1_ = true;
               this.var_1382 = this.var_493;
            }
         }
         this.var_1380 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_244)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_987 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1671 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_564 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_339 || _loc1_.actionType == AvatarAction.const_221 || _loc1_.actionType == AvatarAction.const_395)
               {
                  this.var_987 = true;
               }
            }
