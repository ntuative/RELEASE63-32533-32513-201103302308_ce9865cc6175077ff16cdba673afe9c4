package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_3;
         this._assets = param4;
         this.var_867 = String(param1);
         this._revision = String(param2);
         this.var_1336 = param3 + this.var_867 + ".swf";
         ...
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_867 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_867);
            this._state = name_4;
         }
      }
      ...
      {
         var _loc1_:String = this.var_867;
