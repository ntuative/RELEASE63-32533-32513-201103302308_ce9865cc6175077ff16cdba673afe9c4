   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_68,FigureData.const_242,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_68,FigureData.const_276,_windowManager,_assetLibrary);
         }
         else
         {
