package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2066:String = "hd-99999-99999";
      ...
      private var var_314:PetDataManager;
      
      private var var_776:PaletteManager;
      ...
      private var var_1840:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_583 = RenderMode.const_1521;
         ...
         this.var_106.add(AvatarType.const_113,_loc4_);
         ...
         this.var_106.add(AvatarType.const_64,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_314 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_776 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_314.populateFigureData(_loc5_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_314.init();
         this.var_776.init();
         _loc2_ = this.var_106.getValue(AvatarType.const_113) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_106.getValue(AvatarType.const_64) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_106.getValue(AvatarType.const_113) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1045,this.onFigureDataDownloadDone);
      ...
      private function checkIfReady() : void
      {
         if(!this.var_900)
         {
            if(this.var_2602 && this.var_2603 && this.var_2604)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_106.getValue(AvatarType.const_113) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1840)
         {
            this.var_1840 = new AvatarFigureContainer(this.const_2066);
         }
         this.var_221.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1840,param2);
      }
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_314.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1476)
         {
            _loc6_ = !this.var_314.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_314.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_106.getValue(AvatarType.const_64) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_314.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_106.getValue(AvatarType.const_64);
      ...
      {
         var _loc3_:AvatarStructure = this.var_106.getValue(AvatarType.const_113) as AvatarStructure;
      ...
      {
         return this.var_314 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_64:
               _loc3_ = this.var_106.getValue(AvatarType.const_64) as AvatarStructure;
               break;
            default:
