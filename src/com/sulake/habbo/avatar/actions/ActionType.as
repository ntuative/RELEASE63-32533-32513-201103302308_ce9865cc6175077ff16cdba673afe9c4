package com.sulake.habbo.avatar.actions
{
   public class ActionType
   {
      ...
      public function ActionType(param1:XML)
      {
         ...
         this._preventHeadTurn = String(param1.@preventheadturn) == "HabboUserDefinedRoomEventsCom_move_vrt_png";
         ...
         {
            this.var_1616 = _loc3_ == "HabboUserDefinedRoomEventsCom_move_vrt_png";
         }
      }
