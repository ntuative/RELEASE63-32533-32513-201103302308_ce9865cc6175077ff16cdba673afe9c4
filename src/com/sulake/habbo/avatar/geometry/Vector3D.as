package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      {
         return this._x * param1.x + this.var_154 * param1.y + this.var_153 * param1.z;
      }
      
      public function cross(param1:Vector3D) : Vector3D
      {
         var _loc2_:Vector3D = new Vector3D();
         _loc2_.x = this.var_154 * param1.z - this.var_153 * param1.y;
      ...
      {
         return Math.sqrt(this._x * this._x + this.var_154 * this.var_154 + this.var_153 * this.var_153);
      }
      
      public function toString() : String
      {
         return "Vector3D: (" + this._x + "," + this.var_154 + "," + this.var_153 + ")";
      }
