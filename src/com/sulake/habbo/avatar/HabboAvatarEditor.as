package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_1192:AvatarEditorHandler;
      ...
      private var var_978:IFigureData;
      ...
      {
         this.var_1017 = FigureData.const_78;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_196)
         {
            ...
            this.var_653["null"] = new FigureData(this);
            this.var_653["null"] = new FigureData(this);
            _loc2_ = this.var_653["null"];
            _loc3_ = this.var_653["null"];
            _loc2_.loadAvatarData(const_1386,FigureData.const_78);
            _loc3_.loadAvatarData(const_1385,FigureData.FEMALE);
            this.var_102 = new Map();
            this.var_526 = new Map();
            this.var_102.add(AvatarEditorFigureCategory.const_813,new BodyModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_236,new TorsoModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_754,new LegsModel(this));
            ...
            this.var_526.add(AvatarEditorSideCategory.const_109,new WardrobeModel(this));
            this.var_526.add(AvatarEditorSideCategory.const_545,new ClubPromoModel(this));
            this.var_196 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_653[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_978.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_978.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_266 == null)
            {
               this.var_266 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_65,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_266.addChild(this._view.window);
               if(param5)
               {
                  this.var_266.center();
               }
      ...
      {
         this.var_978 = this.var_525.getFigureData(AvatarType.const_113);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1192 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_653[this.var_1017];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1864;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1193 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1387)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1570.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1300.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1193 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1300.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1193 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_526.getValue(AvatarEditorSideCategory.const_109);
      }
