package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_612 = _loc4_.content as BitmapData;
         ...
         this.var_918 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_612.width,this.var_612.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_612,this.var_612.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_919.width,this.var_919.height,true,0);
            _loc5_ = this.var_919.clone();
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_918.width,this.var_918.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_918,this.var_918.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_992)
            {
               switch(this.var_992.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_45:
                     _loc4_.style = HabboIconType.const_775;
                     _loc4_.visible = true;
               }
            }
            else
