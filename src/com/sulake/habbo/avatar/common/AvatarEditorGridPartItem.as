package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private const const_2044:int = 13421772;
      
      private const const_2045:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_691 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1674 = Math.max(this.var_1674,_loc6_.colorLayerIndex);
            }
         }
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_691 != null && !this.var_1673)
            {
               _loc3_ = this.var_691;
            }
            else
            ...
            if(this.var_729)
            {
               switch(this.var_729.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_45:
                     _loc2_.style = HabboIconType.const_775;
               }
            }
            else
            {
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_342[_loc6_] + "_" + FigureData.const_157;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_592 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1672)
               {
                  ...
                  this.var_1672 = _loc9_.content as BitmapData;
               }
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1673 && _loc2_.colorLayerIndex > 0)
               {
