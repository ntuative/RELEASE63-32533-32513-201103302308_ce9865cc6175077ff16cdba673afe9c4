package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2025:Number = 1.0;
      ...
      {
         super();
         this.var_1836 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2594 = parseInt(_loc2_,16);
         this.var_2593 = parseInt(_loc3_,16);
         ...
         this.var_873 = new ColorTransform(this.var_2027,this.var_2026,this.var_2025,this._alphaMultiplier);
         this.var_1164 = this.generatePaletteMapForGrayscale(this.var_2593,this.var_2594);
      }
