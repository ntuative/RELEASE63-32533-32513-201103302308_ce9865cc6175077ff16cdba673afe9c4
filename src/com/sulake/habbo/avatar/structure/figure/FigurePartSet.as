package com.sulake.habbo.avatar.structure.figure
{
   public class FigurePartSet implements IFigurePartSet
   {
      ...
      public function FigurePartSet(param1:XML, param2:String)
      {
         ...
         this.var_2185 = parseInt(param1.@club);
         this.var_1476 = Boolean(parseInt(param1.@colorable));
         this.var_2184 = Boolean(parseInt(param1.@selectable));
         ...
         {
            this.var_1343.push(String(_loc4_.@parttype));
         }
      }
