package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_671 && this.var_1532)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_93,this.var_1017,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_36,parseInt(FigureData.const_877));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_671 = this._controller.figureData.getFigureString();
               this.var_1017 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1968,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_671)
               {
                  this._controller.loadAvatarInEditor(this.var_671,this.var_1017,this._controller.clubMemberLevel);
               }
         }
      }
