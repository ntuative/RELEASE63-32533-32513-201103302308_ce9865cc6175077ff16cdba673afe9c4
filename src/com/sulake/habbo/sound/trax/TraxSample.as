package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample
   {
      ...
      private var var_1519:Vector.<Number> = null;
      ...
      public function TraxSample(param1:ByteArray, param2:int)
      {
         ...
         this.var_1519 = new Vector.<Number>(_loc3_,true);
         param1.position = 0;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            ...
            param1.readFloat();
            if(_loc4_ >= _loc3_ - 1 - const_1014)
            {
               _loc5_ *= (_loc3_ - _loc4_ - 1) / Number(const_1014);
            }
            this.var_1519[_loc4_] = _loc5_;
            _loc4_++;
         }
      }
