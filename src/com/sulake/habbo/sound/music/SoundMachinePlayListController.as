package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_239 = param2;
         this.var_774 = [];
         this.var_774.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_774.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         ...
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_704,this.onSoundMachinePlayEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_880,this.onSoundMachineStopEvent);
      }
      ...
      {
         return HabboMusicPrioritiesEnum.const_202;
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_81)
            {
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_704,this.onSoundMachinePlayEvent);
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_880,this.onSoundMachineStopEvent);
               this.var_81 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_479);
      ...
      {
         this.var_239.stop(HabboMusicPrioritiesEnum.const_202);
         this.var_479 = -1;
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_239.playSong(param1,HabboMusicPrioritiesEnum.const_202,_loc3_))
         {
      ...
      private function onPlayListMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc8_ < _loc5_.length)
         {
            ...
            {
               this.var_479 = _loc6_.id;
               _loc6_.startPlayHeadPos = Number(_loc4_) / 1000;
            }
            _loc4_ -= _loc6_.length;
            _loc8_++;
         }
         this._events.dispatchEvent(new PlayListUpdatedEvent(PlayListUpdatedEvent.const_486));
