package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2738 = this._config.getKey("interstitial.enabled","false") == "HabboUserDefinedRoomEventsCom_move_vrt_png";
         this.var_2739 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2741 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1947 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1947 > 0 && this.var_1945 >= this.var_1947)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1242;
         if(_loc1_ > this.var_2739)
         {
            ++this.var_1945;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(this.var_1516 != "")
         {
            ...
            {
               this.var_230 = new Timer(this.var_2741,1);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_546,0,0,param1.bitmapData,this.var_2740));
            this.var_1242 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_444));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1517 = _loc2_.imageUrl;
         this.var_1946 = _loc2_.clickUrl;
         if(this.var_1517 != "" && this.var_1946 != "")
         {
            _loc3_ = this.var_1517;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1517);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_462,0,0,_loc4_,_loc2_.assetName,this.var_1946,this.var_1241,this.var_1240));
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_665.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_665.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_665.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_722,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_792,_loc5_.roomId,0,null,_loc5_.imageUrl,_loc5_.clickUrl,null,null,_loc5_.objectId));
         }
      }
   }
}
