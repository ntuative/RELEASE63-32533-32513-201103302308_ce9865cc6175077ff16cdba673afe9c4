package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_684 = this.getKey("url_prefix");
         if(this.var_684 != null && this.var_684.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_684 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. URL " + this.getKey("external.variables.txt") + "HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1653);
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         for each(line in rows)
         {
            if(line.substr(0,1) != "#")
            {
               ...
               if(pair[0].length > 0 && pair[1].length > 0)
               {
                  ...
                  if(key == "configuration.readonly" && value == "HabboUserDefinedRoomEventsCom_move_vrt_png")
                  {
                     readOnly = true;
                  }
         ...
         if(this.getKey("local.environment") == "HabboUserDefinedRoomEventsCom_move_vrt_png")
         {
            this.setKey("url.prefix",this.getKey("url.prefix.local"));
         }
         this.var_684 = this.getKey("url.prefix");
         if(this.var_684.length > 0)
         {
            externalAccessDomain = this.var_684.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_1283[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_1283[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_684);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         ...
         if(this.var_2033.indexOf(param1) < 0 || param3)
         {
            this.var_1283[param1] = param2;
         }
         if(param3)
         {
            this.var_2033.push(param1);
         }
      }
