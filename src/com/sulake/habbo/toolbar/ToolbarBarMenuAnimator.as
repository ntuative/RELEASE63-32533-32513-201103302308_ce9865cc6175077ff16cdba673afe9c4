package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1395:Number = 90;
      ...
      private var var_1441:ToolbarView;
      
      private var var_759:Timer;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_759 = new Timer(const_1353);
         this.var_759.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_359[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_984 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_984 || param1.desktop.height - param1.y < const_1352;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1441.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_359.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1441.getIconLoc(param1.iconId);
      ...
      {
         return this.var_626[this.var_627.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_627[this.var_626.indexOf(param1)];
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_359.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_359.splice(this.var_359.indexOf(param1),1);
            }
         }
      }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_359.length)
         {
            _loc2_ = this._itemList[this.var_359[_loc7_]];
            if(_loc2_.active)
            {
