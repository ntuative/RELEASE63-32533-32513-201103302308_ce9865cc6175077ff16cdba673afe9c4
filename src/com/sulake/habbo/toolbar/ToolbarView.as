package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_2023:Number = 15;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_236 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_65,HabboWindowStyle.const_1034,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         this._window.tags.push("habbo_extrabar");
         if(param5.getKey("friendbar.enabled") == "HabboUserDefinedRoomEventsCom_move_vrt_png")
         {
         ...
         this.var_1281 = String(_loc8_.relocate_by_drag.@state) == "HabboUserDefinedRoomEventsCom_move_vrt_png";
         if(this.var_1281)
         {
         ...
         this.var_1280 = _loc8_.toolbar.@margin_top;
         this.var_1562 = _loc8_.toolbar.@margin_bottom;
         this.var_2023 = _loc8_.toolbar.@min_group_margin;
         this.var_2024 = _loc8_.toolbar.@margin_to_extrabar;
         this.var_332 = new ToolbarBarMenuAnimator(param1,this);
         var _loc9_:XMLList = XMLList(_loc8_.toolbar).children();
         var _loc10_:XMLList = XMLList(_loc8_.extras).children();
         this.createGroupsFromXmlList(_loc9_,this.var_282,param1,param2,param3,this._window,this.var_332);
         this.createGroupsFromXmlList(_loc10_,this.var_682,param1,param2,param3,this.var_236,this.var_332);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_172);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_172,this.var_553,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_553);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_172,this.var_553);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_172,this.var_553);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_904);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_682.length)
         {
            _loc2_ = this.var_682[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_236.x = this.var_172 + this.var_2024;
               this.var_236.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_236.x = 0;
               this.var_236.y = this.var_172 + this.var_2024;
         ...
         else
         {
            ...
            if(this.var_282.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_2023,(this._window.height - _loc5_ * _loc8_ - this.var_1280 - this.var_1562) / (this.var_282.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_2023,(this._window.width - _loc5_ * _loc8_ - this.var_1280 - this.var_1562) / (this.var_282.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_282.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_553;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1281 && this.var_1561)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_553)
            {
               this.var_553 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_503);
                  _loc3_.orientation = this.var_553;
