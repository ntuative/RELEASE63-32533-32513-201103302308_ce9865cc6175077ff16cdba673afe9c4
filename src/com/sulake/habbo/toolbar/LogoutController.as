package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private const const_1759:int = 10;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_1759;
         _loc3_.y = this.const_1759;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_573)
         {
            this.var_573 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
