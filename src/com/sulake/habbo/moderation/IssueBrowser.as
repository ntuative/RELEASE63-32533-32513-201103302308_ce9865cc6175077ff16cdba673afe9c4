package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2068:String = "my_issues";
      
      private const const_2069:String = "open_issues";
      
      private const const_2070:String = "picked_issues";
      
      private const const_2095:String = "closed_issues";
      ...
      private var var_1865:IIssueBrowserView;
      
      private var var_1866:IIssueBrowserView;
      
      private var var_1867:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_373 == _loc2_)
         {
            return;
         }
         if(this.var_373 != null)
         {
            this.var_373.visible = false;
         }
         this.var_373 = _loc2_;
         if(this.var_373 == null)
         {
         ...
         this.var_373.view.width = this.var_267.container.width;
         this.var_373.view.height = this.var_267.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2068:
               ...
               {
                  this.var_1865 = new MyIssuesView(this.issueManager,this,this.var_267.container);
               }
               return this.var_1865;
            case this.const_2069:
               if(this.var_1866 == null)
               {
                  this.var_1866 = new OpenIssuesView(this.issueManager,this,this.var_267.container);
               }
               return this.var_1866;
            case this.const_2070:
               if(this.var_1867 == null)
               {
                  this.var_1867 = new PickedIssuesView(this.issueManager,this,this.var_267.container);
               }
