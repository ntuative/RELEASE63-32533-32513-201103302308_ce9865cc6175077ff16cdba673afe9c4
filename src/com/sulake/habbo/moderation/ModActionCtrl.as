package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1297:IDropMenuWindow;
      
      private var var_559:ITextFieldWindow;
      
      private var _disposed:Boolean;
      
      private var var_610:Boolean = true;
      
      private var var_1044:OffenceCategoryData;
      
      private var var_1045:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1296 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1295 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1730;
         ...
         this.var_559 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_559.procedure = this.onInputClick;
         this.var_1297 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1297);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1044 != null;
         if(this.var_1045 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1045.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1044 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1044.offences,this.var_1296,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1295,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1567,this.var_559.text,this.var_1568));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1044 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1045 = this.var_1044.offences[_loc3_];
         this.var_559.text = this.var_1045.msg;
         this.var_610 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1567,this.var_559.text,this.var_1568));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1297.selection < 0)
         {
            this.var_35.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1567,this.var_559.text,this.getBanLength(),this.var_1568));
         this.dispose();
      }
      
      private function isMsgGiven() : Boolean
      {
         if(this.var_610 || this.var_559.text == "")
         {
      ...
      {
         var _loc1_:int = this.var_1297.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1296.destroy();
            this.var_1296 = null;
         }
         if(this.var_1295 != null)
         {
            this.var_1295.destroy();
            this.var_1295 = null;
         }
         this.var_1297 = null;
         this.var_559 = null;
