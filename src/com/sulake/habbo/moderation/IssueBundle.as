package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_707:IssueMessageData = null;
      
      private var var_706:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2155 = param2.pickerUserName;
         this.var_1367 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1075 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1074;
         }
         if(this.var_707 == null || param1.timeStamp < this.var_707.timeStamp)
         {
            this.var_707 = param1;
         }
         if(this.var_706 == null || param1.priority > this.var_706.timeStamp)
         {
            this.var_706 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1075 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1074;
            }
            if(this.var_707 == _loc2_)
            {
               this.var_707 = null;
            }
            if(this.var_706 == _loc2_)
            {
               this.var_706 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_706;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_707;
         if(_loc2_ == null)
         {
