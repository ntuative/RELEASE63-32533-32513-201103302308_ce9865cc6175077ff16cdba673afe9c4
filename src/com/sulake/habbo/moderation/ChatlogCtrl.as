package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1769:int = 1000;
      
      private static var var_946:Array = [];
      
      private static var var_1768:int = 200;
      ...
      private var var_1771:IMessageComposer;
      ...
      {
         this.var_760 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_761 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         this.var_502 = new Timer(1000,1);
         ...
         this.var_35.connection.send(this.var_1771);
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1770[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
