package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1721:int = 200;
      ...
      {
         this.var_741 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1600;
      }
