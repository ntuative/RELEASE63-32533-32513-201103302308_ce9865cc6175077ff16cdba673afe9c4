package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1413:uint = 1;
      ...
      private var var_1008:IWindowRenderer;
      
      private var var_903:ISkinContainer;
      
      private var var_274:Array;
      
      private var var_1513:IEventDispatcher;
      
      private var var_1237:Boolean = false;
      
      private var var_1938:ProfilerOutput;
      
      private var var_1512:ProfilerAgentTask;
      
      private var var_1514:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_903 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_1008 = new WindowRenderer(this.var_903);
         ...
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_1008,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_266 = this._windowContextArray[const_1413];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1938)
            {
               this.var_1938 = new ProfilerOutput(context,this,this.var_1008);
            }
            this.var_1938.profiler = _loc3_;
            this.var_1512 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1512);
            this.var_1514 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1514);
            this.var_1237 = true;
         }
      }
      ...
      {
         return this.var_903.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1513.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_434 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1513.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         this.var_1513.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1573,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1623,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1502,param2.name + ": " + param2.toString());
            }
         }
      }
