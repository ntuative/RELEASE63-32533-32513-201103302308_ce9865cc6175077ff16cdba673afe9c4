package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_392:PetsGridItem;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_392);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_675.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_268.removeGridItem(_loc2_.window);
         if(this.var_392 == _loc2_)
         {
            this.var_392 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_675 == null || this.var_675.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_675.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_675.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_675.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_392.pet;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowEvent.const_62)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.var_68.switchCategory(FurniModel.const_52);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_392 != null)
         {
            this.var_392.setSelected(false);
         }
         this.var_392 = param1;
         if(this.var_392 != null)
         {
            this.var_392.setSelected(true);
         }
