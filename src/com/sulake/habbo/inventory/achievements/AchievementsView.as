package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_460 = new Timer(1000,1);
         this.var_460.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_303.events.addEventListener(BadgeImageReadyEvent.const_154,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_460)
            {
               this.var_460.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_460.reset();
               this.var_460 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_460.running);
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = this.var_303.getBadgeImage(param2.badgeId);
