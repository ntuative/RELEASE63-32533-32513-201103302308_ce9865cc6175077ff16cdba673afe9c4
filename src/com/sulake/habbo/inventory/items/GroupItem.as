package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_691:BitmapData;
      
      protected var var_2494:int;
      
      protected var var_1575:Boolean;
      
      protected var var_2097:Boolean;
      
      protected var var_2867:BitmapData;
      
      private const const_2044:int = 8947848;
      
      private const const_2045:int = 13421772;
      
      private const const_1769:Number = 1;
      
      private const const_1770:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2866 == FurniModel.const_46)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1490));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2096);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_819)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1770;
               _loc1_.blend = this.const_1770;
            }
            else
            {
               this._window.blend = this.const_1769;
               _loc1_.blend = this.const_1769;
            }
         }
         if(this.isSelected)
         {
            this.var_1383.color = this.const_2044;
         }
         else
         {
            this.var_1383.color = this.const_2045;
         }
         ...
         if(_loc5_)
         {
            if(this.var_2097 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2867;
               _loc5_.visible = true;
            }
            else
            {
