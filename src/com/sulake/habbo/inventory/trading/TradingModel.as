package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1674:uint = 9;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_54.updateItemList(this.var_732);
         this.var_54.updateItemList(this.var_1387);
      ...
      {
         this.var_54.setMinimized(param1 != InventoryCategory.const_76);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_733 + " OTHER: " + this.var_1101);
         ...
         {
            case const_189:
               if(param1 == const_176 || param1 == const_277)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_54.alertPopup(TradingView.const_1101);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_732)
            {
               this.var_733 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1101 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_54.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_732)
            {
               this.var_54.alertPopup(TradingView.const_1035);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_245.length < const_1674)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_195)
            {
