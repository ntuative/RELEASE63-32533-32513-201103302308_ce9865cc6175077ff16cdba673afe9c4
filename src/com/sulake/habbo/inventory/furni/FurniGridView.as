   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_68.toggleItemSelection(this._category,this.var_268.getGridItemIndex(param1.window));
            this.var_637 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_637 != null && this.var_637 == param2 && !this.var_68.isTradingOpen)
         {
