package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2093:int = 0;
      
      private const const_982:int = 1;
      
      private const const_1765:int = 2;
      
      private const const_1766:int = 3;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_504 = param6;
         this.var_504.events.addEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
         this.var_429 = new Map();
         this.var_429.add(FurniModel.const_46,new FurniGridView(this.var_68,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_429.add(FurniModel.const_52,new FurniGridView(this.var_68,FurniModel.const_52,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_504)
            {
               this.var_504.events.removeEventListener(SongInfoReceivedEvent.TRAX_SONG_INFO_RECEIVED,this.onSongInfoReceivedEvent);
               this.var_504 = null;
            }
            this.var_185 = null;
            this._disposed = true;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_429.getValue(this.var_430);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_430);
         if(!this.var_68.isListInited())
         {
            _loc2_ = this.const_982;
         }
         ...
         if(this.var_2394 == _loc2_)
         {
            return;
         }
         this.var_2394 = _loc2_;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_430);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_389)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_195)
               {
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_778)
               {
                  ...
                  else
                  {
                     ...
                     this.var_185.push(_loc5_.extra);
                  }
               }
            }
         ...
         else if(param1.type == WindowEvent.const_62)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_414);
            }
         }
      }
      ...
      {
         if(this.var_185.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_185.indexOf(param1.id as Number) != -1)
            {
               this.var_185.splice(this.var_185.indexOf(param1.id as Number),1);
            }
         }
      }
   }
