package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1274:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1273 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1273.procedure = this.inactiveGridEventProc;
         this.var_1274 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1274.procedure = this.activeGridEventProc;
      }
      ...
      private function updateListViews() : void
      {
         ...
         while(_loc3_ < _loc4_.length)
         {
            ...
            this.var_1274.addGridItem(_loc2_.window);
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = this.var_1274.getGridItemIndex(param1.window);
