package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      private function showConfirmation() : void
      {
         ...
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","price",this.var_1714.toString());
      ...
      private function confirmationCallback(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            this.var_68.makeOffer(this.var_1714);
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "make_offer_button":
                  ...
                  if(_loc3_ != null)
                  {
                     this.var_1714 = parseInt(_loc3_.text);
      ...
      {
         var _loc1_:* = null;
         if(false && "HabboUserDefinedRoomEventsCom_move_vrt_png" == this._config.getKey("client.credits.embed.enabled"))
         {
