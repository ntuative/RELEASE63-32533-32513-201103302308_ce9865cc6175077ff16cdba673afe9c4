package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1156:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1795 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1156 = this.var_1795.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1156)
         {
            this.var_1156.procedure = this.onButtonClick;
         }
         this.var_1155 = this.var_1795.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1155)
         {
      ...
      {
         if(this.var_258 >= this.var_69.length - 1)
         {
         ...
         if(this.var_258 <= 0)
         {
            this.var_1156.disable();
         }
         else
         {
            this.var_1156.enable();
         }
      }
      ...
      {
         ++this.var_258;
         this.var_258 = Math.min(this.var_258,this.var_69.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_69[this.var_258][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_69[this.var_258][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_69[this.var_258][1]).value;
            this.setPreviewFromAsset(_loc4_);
         }
      }
      
      private function method_2(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         if(param2 == null)
         {
            return;
      ...
      private function setPreviewFromAsset(param1:String) : void
      {
         ...
         if(_loc3_)
         {
            this.method_2(_loc3_,_loc2_.content as BitmapData);
         }
      }
