package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1290:Number = 1.0;
      
      private var var_686:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1290,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1040);
         }
      ...
      {
         return int(this.var_1707 * (Number(param1 - this._minValue) / (this.var_1290 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1707 * (this.var_1290 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1041)
         {
            if(param1.type == WindowMouseEvent.const_58 || param1.type == WindowMouseEvent.const_199)
            {
               this.var_1041 = false;
            }
         }
         if(!this.var_1041 || param1.type != WindowEvent.const_349)
         {
            return;
         }
         if(this.var_686 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_686) * this.var_686;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_686 != 0)
            {
               _loc3_ = this.var_1040 + this.var_686;
