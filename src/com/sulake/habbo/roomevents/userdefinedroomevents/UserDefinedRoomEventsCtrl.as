package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1515:int = 2;
      ...
      private var var_1940:TriggerConfs;
      
      private var var_1939:ActionTypes;
      
      private var var_1941:ConditionTypes;
      
      private var var_275:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_807:RoomObjectHightLighter;
      
      private var var_134:UserDefinedRoomEventsHelp;
      
      private var var_1238:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1940 = new TriggerConfs();
         this.var_1939 = new ActionTypes();
         this.var_1941 = new ConditionTypes();
         this.var_275 = new Dictionary();
         super();
         this.var_81 = param1;
         this.var_807 = new RoomObjectHightLighter(param1);
         this.var_134 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1238 = new SliderWindowController(this.var_81,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_81.assets,0,20,1);
         this.var_1238.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1238.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_807.hideAll(this.var_275);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_807.showAll(this.var_275);
         if(this.var_36 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_36);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1238.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1238.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_134.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1515) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1515 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1940);
         this.refreshConfigureElement(this.var_1939);
