package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_993:String = "bg";
      ...
      {
         this._view.getChildByName(const_993).style = HabboWindowStyle.const_32;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_993).style = 3;
      }
