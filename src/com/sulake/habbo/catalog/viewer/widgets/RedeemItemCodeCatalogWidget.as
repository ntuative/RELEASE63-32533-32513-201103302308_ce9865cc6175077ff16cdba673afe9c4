package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_880:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_880.removeEventListener(WindowKeyboardEvent.const_190,this.windowKeyEventProcessor);
            this.var_880 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_880 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_880 != null)
         {
            this.var_880.addEventListener(WindowKeyboardEvent.const_190,this.windowKeyEventProcessor);
         }
         return true;
      }
