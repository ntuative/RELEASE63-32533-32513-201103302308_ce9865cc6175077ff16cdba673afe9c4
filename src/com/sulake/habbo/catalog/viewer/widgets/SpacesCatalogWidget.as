package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_212:String = "floor";
      ...
      private var var_1619:String = "SetActivatedBadgesComposer";
      ...
      private var _floorType:String = "SetActivatedBadgesComposer";
      ...
      private var var_344:BitmapData = null;
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1344[this.var_411];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1345[this.var_414];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1346[this.var_413];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_878[this.var_411];
         ...
         var _loc5_:String = this._activeFloorPatterns[this.var_414];
         for each(_loc1_ in this.var_183.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[this.var_482];
               if(_loc11_ != null)
               {
         ...
         _loc6_ = this.var_1345[this.var_414];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_874[this.var_413];
         for each(_loc1_ in this.var_183.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               ...
               if(_loc13_ != null)
               {
                  this.var_1618 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1346[this.var_413];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_211:
               ...
               if(this.var_411 < 0)
               {
                  this.var_411 = this.var_878.length - 1;
               }
               if(this.var_411 == this.var_878.length)
               {
                  this.var_411 = 0;
               }
               this.var_412 = 0;
               this.var_875 = 0;
               _loc5_ = this.var_878[this.var_411];
               for each(_loc8_ in this.var_183.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_875 = _loc8_.children().length();
                  }
               }
            ...
            case const_212:
               ...
               if(this.var_414 < 0)
               {
                  this.var_414 = this._activeFloorPatterns.length - 1;
               }
               if(this.var_414 >= this._activeFloorPatterns.length)
               {
                  this.var_414 = 0;
               }
               this.var_482 = 0;
               this.var_877 = 0;
               _loc6_ = this._activeFloorPatterns[this.var_414];
               for each(_loc9_ in this.var_183.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_413 < 0)
               {
                  this.var_413 = this.var_874.length - 1;
               }
               if(this.var_413 >= this.var_874.length)
               {
                  this.var_413 = 0;
               }
               this.var_483 = 0;
               this.var_876 = 0;
               _loc7_ = this.var_874[this.var_413];
               for each(_loc10_ in this.var_183.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_876 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1619,this.var_1618,64,this,"window_romantic_wide");
         ...
         {
            this.var_1617 = _loc2_.id;
            this.var_1620 = _loc3_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_344 != null && this.var_345 != null)
         {
            this.setRoomImage(this.var_344,this.var_345);
         }
      }
   }
}
