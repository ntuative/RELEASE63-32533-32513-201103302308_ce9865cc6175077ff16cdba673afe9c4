package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_683[this.var_1282][this.var_2030];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1282 = var_1058.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1282];
         var _loc3_:Array = this.var_683[this.var_1282] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_2030 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_2030] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_562 || _loc1_.pricingModel == Offer.const_459)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_74 || _loc3_.productType == ProductTypeEnum.const_87)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_683.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_683[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
