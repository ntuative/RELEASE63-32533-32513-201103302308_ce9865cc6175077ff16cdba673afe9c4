package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_990:ITextWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_990 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1209 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1891 = new Point(this.var_87.x,this.var_87.y);
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_990.text = _loc4_;
         this.var_1209.text = _loc5_;
         this.var_990.height = this.var_990.textHeight + 5;
         this.var_1209.y = this.var_990.y + this.var_990.height;
         this.var_1209.height = Math.max(130,this.var_1209.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_451:
                  ...
                  if(this.var_535 != null)
                  {
                     ...
                     _loc10_.populateItemGrid(this.var_535,this.var_1488,this.var_1900);
                     ...
                     case ProductTypeEnum.const_207:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_318,AvatarAction.const_601);
                              _loc16_.appendAction(AvatarAction.const_307,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2686)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2686 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_87 != null && true)
         {
            ...
            this.var_87.x = this.var_1891.x;
            this.var_87.y = this.var_1891.y;
            if(param3 != null)
            {
