package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1361:int = 16763904;
      
      private static const const_1363:int = 13421772;
      
      private static const const_1362:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_259.getWithIndex(this.var_309);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_772);
            if(_loc3_ == null)
            {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_259.getWithIndex(this.var_309);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_772);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_309;
         if(this.var_309 >= this.var_259.length)
         {
            this.var_309 = 0;
         }
         var _loc2_:Map = this.var_259.getWithIndex(this.var_309);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_309 < 0)
         {
            this.var_309 = this.var_259.length - 1;
         }
         var _loc2_:Map = this.var_259.getWithIndex(this.var_309);
         if(_loc2_ != null)
         {
