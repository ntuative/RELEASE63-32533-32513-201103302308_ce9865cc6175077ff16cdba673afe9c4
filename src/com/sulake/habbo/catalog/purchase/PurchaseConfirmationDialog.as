package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1784:uint = 4.293848814E9;
      
      private const const_1785:uint = 4.294967295E9;
      
      private const const_2075:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1887 = _loc1_.stuffTypes;
            this.var_792 = _loc1_.boxTypes;
            this.var_791 = _loc1_.ribbonTypes;
            this.var_1207 = this.var_1887[0];
            this.var_377 = this.var_792[0];
            this.var_376 = this.var_791[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_376 < 0)
         {
            this.var_376 = this.var_791.length - 1;
         }
         if(this.var_376 > this.var_791.length - 1)
         {
            this.var_376 = 0;
         }
         if(this.var_377 < 0)
         {
            this.var_377 = this.var_792.length - 1;
         }
         if(this.var_377 > this.var_792.length - 1)
         {
            this.var_377 = 0;
         }
         var _loc1_:int = this.var_792[this.var_377] * 1000 + this.var_791[this.var_376];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_94.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1207,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1486 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1887;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1207);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_792[this.var_377]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_791[this.var_376]);
         this._catalog.purchaseProductAsGift(this.var_1485,this.var_94,this.var_1487,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1485,this.var_94.offerId,this.var_1487);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_106:
               ...
               for each(_loc7_ in this.var_224)
               {
                  ...
                  if(_loc5_.length >= this.const_2074)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2674 = _loc3_.text;
               break;
            case WindowMouseEvent.const_42:
               ...
               break;
            case WindowKeyboardEvent.const_351:
      ...
      {
         if(this.var_269 == null || !this.var_269.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_269.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_269 == null)
         {
            this.var_269 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_655 == null)
         {
            this.var_655 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_655.procedure = this.suggestionsEventHandler;
         }
         if(this.var_269 == null || this.var_655 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_269.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_655.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2075;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1784) : uint(this.const_1785);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_269.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1207;
               }
            }
            _loc4_++;
         }
