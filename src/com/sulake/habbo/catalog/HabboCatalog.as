package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_1094:IRoomSession;
      ...
      private var var_2631:GiftWrappingConfiguration;
      
      private var var_1178:ClubGiftController;
      
      private var var_521:ClubBuyController;
      
      private var var_780:Map;
      
      private var var_1177:Boolean = false;
      
      private var var_971:IPurchasableOffer;
      
      private var var_1176:IDragAndDropDoneReceiver;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_521.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_183.getKey("client.credits.embed.enabled","false") == "HabboUserDefinedRoomEventsCom_move_vrt_png";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_303.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_303.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_74)
         {
            _loc3_ = this.var_303.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_780.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_107.getActivityPointsForType(Purse.const_183)));
         var _loc1_:int = 0;
      ...
      {
         this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_840)
         {
            if(!this.var_303.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_318.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_318 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_318.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this.method_2("layoutBackground",_loc2_.content as BitmapData);
         var _loc3_:IWindowContainer = this._mainContainer.findChildByName("navigatorMain") as IWindowContainer;
         _loc3_.setParamFlag(WindowParam.const_245,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_84:
               this.var_1853 = param1.session.isPrivateRoom;
               this.var_1094 = param1.session;
               if(this.var_93 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1178 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_521 == null)
         {
            this.var_521 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_781 && this.var_781 != "")
         {
            this.var_369.openPage(this.var_781);
            this.var_781 = "";
            this.var_970 = -1;
         }
         else if(this.var_970 > -1)
         {
            this.var_369.openPageById(this.var_970,this.var_1852);
            this.var_970 = -1;
            this.var_1852 = -1;
            this.var_781 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_318.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_318.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2632 && this.var_504 != null)
         {
            this.var_504.playSound(HabboSoundTypesEnum.const_1056);
         }
         this.var_2632 = false;
         if(this.var_319 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_69,this.var_107.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2630 && this.var_504 != null)
         {
            this.var_504.playSound(HabboSoundTypesEnum.const_1173);
         }
         this.var_2630 = false;
         if(this.var_319 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1178.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_318.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2631 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_780.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_780.add(_loc2_.productCode,_loc3_.slice());
            this.var_318.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      
      private function method_2(param1:String, param2:BitmapData) : void
      {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "HabboUserDefinedRoomEventsCom_move_vrt_png" == this.var_183.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      public function requestSelectedItemToMover(param1:IDragAndDropDoneReceiver, param2:Offer) : void
      {
         ...
         if(!this.var_183.keyExists("catalog.drag_and_drop") || this.var_183.getKey("catalog.drag_and_drop") != "HabboUserDefinedRoomEventsCom_move_vrt_png")
         {
            return;
         }
         if(!this.var_1094 || !this.var_1094.isRoomOwner)
         {
            return;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_1177 && param1.type == RoomEngineObjectEvent.const_170)
         {
            this.resetPlacedOfferData();
            if(this.var_971 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_86 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_971);
            if(this.var_1176 != null)
            {
               this.var_1176.onDragAndDropDone(true);
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_971.productContainer.firstProduct;
            ...
            if(_loc4_)
            {
               _loc4_.getModelController().setNumber(RoomObjectVariableEnum.const_309,0.5);
            }
            this.resetObjectMover();
         }
      }
      ...
      public function resetPlacedOfferData() : void
      {
         if(this.var_86 != null)
         {
            if(this.var_86.category == RoomObjectCategoryEnum.const_28)
            {
