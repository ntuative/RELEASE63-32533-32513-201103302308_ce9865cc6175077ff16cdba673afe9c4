package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_423:int = 1;
      ...
      {
         return this.var_572 != const_943;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1585 != RecyclerStatusMessageEvent.const_1162;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_572 == const_423;
      }
      ...
      {
         this.var_572 = const_942;
         this.var_111 = new Array(const_205);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_205)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_572 = const_943;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1547:
               this.var_572 = const_423;
            ...
            case RecyclerStatusMessageEvent.const_1162:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1466:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1070:
               if(this._view != null)
               {
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_111.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_205)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_111.length < const_205)
         {
            return false;
         }
         var _loc1_:int = 0;
