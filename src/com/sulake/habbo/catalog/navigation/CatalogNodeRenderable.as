package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1436:Number = 4285716709;
      ...
      private var var_2012:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2915:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_2012 == 4294967295)
            {
               this.var_2012 = _loc1_.color;
            }
            _loc1_.color = const_1436;
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1683;
            }
         }
      }
      ...
      {
         this.var_62 = navigator.catalog.windowManager.buildFromXML(var_1555) as IItemListWindow;
         if(this.var_62 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1556) as IWindowContainer;
         }
         else
         {
         ...
         this.method_2("iconBackgroundBitmap","icon_bg_img",true,color);
         this.initIcon();
      ...
      private function method_2(param1:String, param2:String, param3:Boolean = true, param4:uint = 0) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc8_:int = 0;
