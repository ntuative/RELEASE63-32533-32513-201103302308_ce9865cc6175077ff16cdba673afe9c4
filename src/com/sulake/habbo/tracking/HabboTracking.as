package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_977:uint = 11;
      ...
      private var var_1134:IHabboWindowManager;
      
      private var var_187:IHabboToolbar;
      
      private var var_134:IHabboHelp;
      ...
      private var var_435:FramerateTracker = null;
      
      private var var_250:LatencyTracker = null;
      
      private var var_618:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_435 = new FramerateTracker();
         this.var_250 = new LatencyTracker();
         this.var_618 = new LagWarningLogger();
         this.var_617 = new ToolbarClickTracker(this);
         this.var_1420 = new Array(const_977);
         var _loc4_:int = 0;
         while(_loc4_ < const_977)
         {
            this.var_1420[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1633,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1668,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_826,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1109,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1134)
            {
               this.var_1134.release(new IIDHabboWindowManager());
               this.var_1134 = null;
            }
            if(this.var_329)
            {
            ...
            if(this.var_202)
            {
               if(!this.var_202.disposed)
               {
                  ...
                  Component(this.var_202).events.removeEventListener(HabboFriendListTrackingEvent.const_370,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_134)
            {
               if(!this.var_134.disposed)
               {
                  this.var_134.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_134.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_134.release(new IIDHabboHelp());
               this.var_134 = null;
            }
            if(this.var_187)
            {
               ...
               {
                  this.var_187.events.removeEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
               }
            ...
            if(this._roomEngine)
            {
               this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_185,this.onRoomAdClick);
               this._roomEngine.events.removeEventListener(RoomEngineEvent.const_334,this.onRoomAction);
               this._roomEngine.events.removeEventListener(RoomEngineEvent.const_294,this.onRoomAction);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_183)
         {
            if(this.var_250 != null)
            {
               this.var_250.configuration = this.var_183;
            }
            if(this.var_251 != null)
            {
               this.var_251.configuration = this.var_183;
            }
            ...
            if(this.var_183)
            {
               ...
               {
                  this.var_618.configure(this.var_183);
               }
               if(this.var_435 != null)
               {
                  this.var_435.configure(this.var_183);
               }
               if(this.var_617 != null)
               {
                  this.var_617.configure(this.var_183);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_178,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_228,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_835,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_71,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_495,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_618 != null)
            {
               this.var_618.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_835)
         {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1607);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_827:
               this.trackLoginStep(HabboLoginTrackingStep.const_1690,String(this._communication.port));
               break;
      ...
      {
         this.var_1134 = IHabboWindowManager(param2);
         if(this.var_1134)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_183)
            {
               if(this.var_183.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1420)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1204);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1204,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_202).events.addEventListener(HabboFriendListTrackingEvent.const_370,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_370:
      ...
      {
         this.var_134 = param2 as IHabboHelp;
         this.var_134.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_134.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2432)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1524);
            this.var_2432 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1109,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_826,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_185,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_334,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_294,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_329 = param2 as IAdManager;
         this.var_329.events.addEventListener(AdEvent.const_462,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_187 = param2 as IHabboToolbar;
         this.var_187.events.addEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_334)
         {
            if(this.var_1746 < 1)
            {
               if(!this.var_305)
         ...
         else if(param1.type == RoomEngineEvent.const_294)
         {
            if(this.var_305)
            {
               this.var_305.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_435)
               {
                  ...
                  this._connection.send(new ConversionPointMessageComposer("Performance","fps",String(this.var_435.frameRate),_loc2_));
                  ++this.var_1746;
               }
            }
         }
      ...
      {
         this.var_618.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_508 > -1 && _loc2_ < this.var_508)
         {
            ++this.var_1747;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1747);
         }
         if(this.var_508 > -1 && _loc2_ - this.var_508 > 15000)
         {
            ++this.var_1745;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1745);
         }
         this.var_508 = _loc2_;
         if(this.var_251 != null)
         {
            this.var_251.update(param1,this.var_508);
         }
         if(this.var_250 != null)
         {
            this.var_250.update(param1,this.var_508);
         }
         if(this.var_435 != null)
         {
            this.var_435.trackUpdate(param1,this,this.var_508);
         }
         if(this.var_618 != null)
         {
            this.var_618.update(this.var_508);
         }
      }
   }
}
