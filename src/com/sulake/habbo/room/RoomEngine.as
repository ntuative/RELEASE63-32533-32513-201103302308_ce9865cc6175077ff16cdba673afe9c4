package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_618:String = "room";
      
      private static const const_975:int = -2;
      
      private static const const_1339:String = "tile_cursor";
      
      private static const const_973:int = -3;
      
      private static const const_1338:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_345:String = "object_icon_sprite";
      
      private static const const_427:int = 15;
      
      private static const const_974:int = 40;
      ...
      private var var_329:IAdManager = null;
      
      private var var_303:ISessionDataManager = null;
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_49 != null)
         {
            ...
            _loc2_ = this.var_49.getRoom(this.getRoomIdentifier(this.var_98,this.var_99));
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         while(_loc2_ < this.var_304.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_98 || _loc6_ != this.var_99 || !this.var_1128)
                  {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc14_ || _loc9_.screenHt != _loc15_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc))
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_887) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_758) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_889) + 0.5;
                  _loc20_ = _loc10_.getNumber(RoomVariableEnum.ROOM_MAX_Y) + 0.5;
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_49 != null)
         {
            ...
            this.var_49.addObjectUpdateCategory(RoomObjectCategoryEnum.const_298);
            this.var_49.addObjectUpdateCategory(RoomObjectCategoryEnum.const_81);
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_646,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_646)
         {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_329.events.addEventListener(AdEvent.const_462,this.showRoomAd);
         this.var_329.events.addEventListener(AdEvent.const_722,this.onRoomAdImageLoaded);
         this.var_329.events.addEventListener(AdEvent.const_792,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_303;
      }
      ...
      {
         if(this.var_747 == null || this.var_522 == null || this.var_49 == null || this.var_929 == null || this._communication == null || this.var_158 == null || !this._contentLoaderReady)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = this.var_356.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1114,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_541,param1,param2));
            }
            else
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_478,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1114);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_507)
         {
            _loc5_ = this.var_356.remove(_loc4_);
            if(_loc5_ != null)
            {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_334,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_344,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1192,param6,true);
            ...
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1249,_loc12_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_344,const_618,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_856,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_929,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_887,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_889,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_758,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.ROOM_MAX_Y,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1111,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_832,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_825,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_840,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_458,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_271);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_802,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_720,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_802,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_720,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1206,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1064,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_975,const_1339,RoomObjectCategoryEnum.const_298);
         if(this.var_158.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_973,const_1338,RoomObjectCategoryEnum.const_298);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_344,RoomObjectCategoryEnum.const_81);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_356.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_356.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_832,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_825,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_840,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1475,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1108,param3);
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_294,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1098;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_929);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_802);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_720);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1206);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1064);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1128 = true;
               this.var_931 = false;
               this.var_2420 = this.var_1417;
               this.var_2419 = this.var_1416;
            }
         }
         else if(param4 == MouseEvent.MOUSE_UP)
         {
            ...
            {
               this.var_1128 = false;
               if(this.var_158.getKey("room.dragging.always_center","0") == "1")
               {
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1128)
            {
               if(!this.var_931)
               {
                  _loc8_ = param2 - this.var_2420;
                  _loc9_ = param3 - this.var_2419;
                  if(_loc8_ <= -const_427 || _loc8_ >= const_427 || _loc9_ <= -const_427 || _loc9_ >= const_427)
                  {
                     this.var_931 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_345);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_488,this.var_98,this.var_99,-1,RoomObjectCategoryEnum.const_161));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_76 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_344,const_618);
                     this.var_76.handleRoomObjectEvent(_loc14_,this.var_98,this.var_99);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_98,this.var_99,this.var_1415);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_345);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_345,_loc5_.data);
            if(_loc10_ != null)
            {
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_98,this.var_99,this.var_1415);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_345);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_98,this.var_99,this.var_1415);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_345);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_76 != null)
         {
            return this.var_76.modifyRoomObject(this.var_98,this.var_99,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_76 != null)
         {
            ...
            {
               return this.var_76.modifyWallItemData(this.var_98,this.var_99,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_76 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_76.deleteWallItem(this.var_98,this.var_99,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(this.var_76 != null)
         {
            return this.var_76.initializeRoomObjectInsert(this.var_98,this.var_99,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_76 != null)
         {
            this.var_76.cancelRoomObjectInsert(this.var_98,this.var_99);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_973,RoomObjectCategoryEnum.const_298);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_975,RoomObjectCategoryEnum.const_298);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_233,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_290,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_403,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_928,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1241,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1087,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_374,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_233,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_290,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_403,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1098,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_374,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
         ...
         if(_loc7_ != null)
         {
            if(_loc7_.getModel() != null)
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1228) > 0)
               {
                  ...
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_458,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_665,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_374,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_934,this.var_98,this.var_99,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_76 != null)
         {
            this.var_76.handleRoomObjectEvent(param1,this.var_98,this.var_99);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_302);
                     break;
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_180,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               ...
               _loc8_.addPlane(RoomPlaneData.const_336,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.getXML();
               param1.getEventHandler().initialize(_loc9_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_869,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_666,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_805,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_458,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc11_:IRoomInstance = this.var_49.getRoom(const_617);
         if(_loc11_ == null)
         {
            _loc11_ = this.var_49.createRoom(const_617,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_746.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_28:
            case RoomObjectCategoryEnum.const_26:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_233,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_302,param7);
               break;
            case RoomObjectCategoryEnum.const_34:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc14_.getModelController().setString(RoomObjectVariableEnum.const_181,param2);
               }
               else
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_645,int(param2));
               }
               break;
         ...
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_746.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_98,this.var_99,const_344,RoomObjectCategoryEnum.const_81,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_49.getRoom(const_617);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_380,param1.image,true);
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1145,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1167,RoomObjectVariableEnum.const_380,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         ...
         {
            this.var_329.loadRoomAdImage(param1,param2,param3,param4);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_722:
               ...
               break;
            case AdEvent.const_792:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1150,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
