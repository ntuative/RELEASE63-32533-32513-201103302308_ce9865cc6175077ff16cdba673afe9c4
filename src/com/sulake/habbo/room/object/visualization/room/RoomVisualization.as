package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1489:int = 13421772;
      
      private static const const_989:int = 16777215;
      
      private static const const_992:int = 13421772;
      
      private static const const_990:int = 10066329;
      
      private static const const_991:int = 10066329;
      
      public static const const_1456:int = 16777215;
      
      public static const const_1739:int = 13421772;
      
      public static const const_1691:int = 10066329;
      ...
      private var var_1157:uint = 16777215;
      
      private var var_2497:int = 255;
      
      private var var_2503:int = 255;
      
      private var var_2502:int = 255;
      ...
      private const const_2063:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_308["null"] = false;
         this.var_308["null"] = true;
         this.var_308["null"] = true;
         this.var_308["null"] = true;
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1106);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1111);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_336)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1456;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1739;
               }
               else
               {
                  _loc13_.color = const_1691;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1594)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_123,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_336)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1921 + this.const_2063 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_364.length)
            {
               _loc11_ = this.var_632[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_364[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1800)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2502 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2503 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2497 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1658)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1545 || _loc3_.y != this.var_2499 || _loc3_.z != this.var_2501 || param1.scale != this.var_2500))
            {
               this.var_1545 = _loc3_.x;
               this.var_2499 = _loc3_.y;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1047);
            if(_loc3_ != this.var_2498)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2498 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_938));
            if(_loc4_ != this.var_1157)
            {
               this.var_1157 = _loc4_;
               this.var_2502 = this.var_1157 & 255;
               this.var_2503 = this.var_1157 >> 8 & 255;
               this.var_2497 = this.var_1157 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_175 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_666);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_869);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_805);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_807));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_797));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_681));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_140.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_212 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      {
         if(param1 != this.var_308["null"] || param2 != this.var_308["null"] || param3 != this.var_308["null"])
         {
            this.var_308["null"] = param1;
            this.var_308["null"] = param2;
            this.var_308["null"] = param3;
            this.var_364 = [];
            this.var_632 = [];
         }
      }
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_212)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_308[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1741;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_123 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_271)
                              {
