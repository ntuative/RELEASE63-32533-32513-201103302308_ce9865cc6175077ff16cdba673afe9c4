   ...
   public class AnimationData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_124 != null)
         {
            ...
            {
               _loc2_ = this.var_124.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function getStartFrame(param1:int) : int
      {
         ...
         return Math.random() * this.var_461;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_124.add(param1,_loc6_);
         var _loc10_:int = _loc6_.frameCount;
         if(_loc10_ > this.var_461)
         {
            this.var_461 = _loc10_;
         }
         return true;
      }
      ...
      {
         var _loc4_:AnimationLayerData = this.var_124.getValue(param2) as AnimationLayerData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationLayerData = this.var_124.getValue(param2) as AnimationLayerData;
         if(_loc6_ != null)
         {
