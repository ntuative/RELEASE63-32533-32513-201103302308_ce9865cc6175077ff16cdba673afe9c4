package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1331:int = 360;
      
      private var var_699:DirectionData = null;
      
      private var var_241:Map;
      
      private var _colors:Map;
      
      private var var_1066:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_699 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_241 != null)
         {
            ...
            {
               _loc2_ = this.var_241.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_699,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_241.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_699);
            this.defineDirection(_loc3_,_loc8_);
            this.var_241.add(String(_loc7_),_loc3_);
            this.var_1589 = -1;
            this.var_1066 = null;
            _loc5_++;
         }
         ...
         while(_loc4_ < param2.length())
         {
            ...
            switch(_loc8_)
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1059);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1331 / 2) % 360 / this.var_1331;
         if(this.var_241.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_241.getKey(_loc5_)) * this.var_1331;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_241.getKey(_loc4_));
         }
         return const_1745;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_241.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_699;
         }
