   ...
   public class AnimationLayerData
   {
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_234.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_461 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         ...
         var _loc3_:* = null;
         param2 /= this.var_2015;
         var _loc4_:Boolean = false;
         var _loc5_:int = 0;
         if(!this.var_1637)
         {
            _loc6_ = param2 / this.var_461;
            param2 %= this.var_461;
            if(this._loopCount > 0 && _loc6_ >= this._loopCount || this._loopCount <= 0 && this.var_461 == 1)
            {
               param2 = this.var_461 - 1;
               _loc4_ = true;
            }
            _loc7_ = 0;
            _loc5_ = 0;
