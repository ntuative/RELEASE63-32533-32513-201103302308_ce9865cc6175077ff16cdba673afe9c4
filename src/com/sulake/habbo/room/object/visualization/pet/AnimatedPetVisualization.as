package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1312:String = "head";
      
      private static const const_610:int = 1;
      
      private static const const_958:int = 1000;
      
      private static const const_1310:String = "pet_experience_bubble_png";
      
      private static const const_1309:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1310) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_350 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2258)
            {
               this.var_2258 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_248);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_136);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_248);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1753 = _loc3_.getNumber(RoomObjectVariableEnum.const_353) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_192);
            if(!isNaN(_loc8_))
            {
               this.var_1669 = _loc8_;
            }
            else
            {
               this.var_1669 = direction;
            }
            this.var_1378 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2259 = _loc3_.getNumber(RoomObjectVariableEnum.const_734);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_645);
            if(_loc9_ != this.var_1668)
            {
               this.var_1668 = _loc9_;
               this.var_2257 = this.var_1668.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_350 != null)
         {
            ...
            if(this.var_1378 > 0)
            {
               _loc2_ = param1 - this.var_1378;
               if(_loc2_ < const_958)
               {
                  this.var_350.alpha = int(Math.sin(_loc2_ / const_958 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_350.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_350.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_610;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2257);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function method_4(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_610)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_610))
            {
               if(param2 >= FurnitureVisualizationData.const_594.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_594[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1669);
         }
         return direction;
      }
      ...
      {
         if(this.var_894[param1] == null)
         {
            if(this._animationData.getTag(var_89,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1312)
            {
               this.var_894[param1] = true;
            }
            else
            {
               this.var_894[param1] = false;
            }
         }
