package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1174:Number = 1.0;
      ...
      private var var_1850:Matrix;
      
      private var _translationMatrix:Matrix;
      
      private var var_765:Number = 1.0;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_779.alphaMultiplier = 1;
         this.var_1470 = new ColorTransform();
         this.var_1850 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_100 = this.var_1175[param1];
         this.var_969 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1851 >= 0)
         {
            this.var_263 = this._visualization.getSprite(this.var_1851);
            if(this.var_263 && this.var_263.asset)
            {
               ...
               if(this.var_85 == null)
               {
                  ...
                  if(this.var_779.alphaMultiplier != 1)
                  {
                     this.var_647 = new BitmapData(this.var_85.width,this.var_85.height,true,4278190080);
                  }
               }
               this.var_2623 = -this.var_263.offsetX;
               this.var_2624 = -this.var_263.offsetY;
            ...
            if(this.var_647)
            {
               this.var_647.fillRect(this.var_647.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_100.y * this.var_1174;
         }
         return 0;
      }
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_969 && this.var_100.hasIgnited)
         {
            this.var_969 = true;
         }
         _loc8_ = this.var_1196 * this.var_1174;
         this.var_100.update();
         if(this.var_969)
         {
            if(this.var_100.roomObjectSpriteId >= 0)
            ...
            {
               this.var_85.draw(this.var_647,this.var_1850,this.var_779,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_100.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2623 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1174;
               _loc4_ = this.var_2624 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1174;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1470.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_85.draw(_loc7_,this._translationMatrix,this.var_1470,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2622 = parseInt(param1.@size);
         this.var_1851 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1196 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1174 = this.var_2622 / 64;
         this.var_765 = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this.var_765 = Math.min(this.var_765,1);
         this.var_779.alphaMultiplier = this.var_765;
         for each(_loc3_ in param1.emitter)
         {
            ...
            for each(_loc23_ in _loc3_.particles.particle)
            {
               ...
               _loc20_ = _loc23_.hasOwnProperty("@fade") && _loc23_.@fade == "HabboUserDefinedRoomEventsCom_move_vrt_png" ? true : false;
               _loc21_ = [];
