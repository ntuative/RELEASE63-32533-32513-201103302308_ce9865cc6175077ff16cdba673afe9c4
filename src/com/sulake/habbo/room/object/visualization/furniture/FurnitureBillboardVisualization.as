   ...
   public class FurnitureBillboardVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               _loc5_ = _loc4_.getString(RoomObjectVariableEnum.const_652);
               if(_loc5_ != null)
               {
                  _loc6_ = _loc4_.getString(RoomObjectVariableEnum.const_479);
                  if(_loc6_ == "HabboUserDefinedRoomEventsCom_move_vrt_png")
                  {
