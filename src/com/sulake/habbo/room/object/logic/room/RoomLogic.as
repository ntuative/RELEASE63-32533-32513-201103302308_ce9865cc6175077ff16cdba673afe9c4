package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1593:int = 255;
      
      private var var_1333:uint = 16777215;
      
      private var var_1594:int = 255;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_604,RoomObjectMouseEvent.const_144];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1106,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_938,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_807,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_797,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_681,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1068)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1593;
            if(_loc2_ - this.var_1068 >= this.var_1592)
            {
               _loc3_ = this.var_1067;
               _loc4_ = this.var_1595;
               this.var_1068 = 0;
            }
            else
            {
               _loc7_ = this.var_1333 >> 16 & 255;
               _loc8_ = this.var_1333 >> 8 & 255;
               _loc9_ = this.var_1333 & 255;
               _loc10_ = this.var_1067 >> 16 & 255;
               _loc11_ = this.var_1067 >> 8 & 255;
               _loc12_ = this.var_1067 & 255;
               _loc13_ = (_loc2_ - this.var_1068) / this.var_1592;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1594 + (this.var_1595 - this.var_1594) * _loc13_;
               this._color = _loc3_;
               this.var_1593 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_938,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_832:
               param2.setString(RoomObjectVariableEnum.const_869,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_825:
               param2.setString(RoomObjectVariableEnum.const_666,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_840:
               param2.setString(RoomObjectVariableEnum.const_805,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_458:
               _loc5_ = "null";
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_665:
               _loc4_ = this.var_517.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_517.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1047,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1254:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1108:
               param2.setNumber(RoomObjectVariableEnum.const_797,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_681,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1333 = this._color;
         this.var_1594 = this.var_1593;
         this.var_1067 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_439,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1676,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1637,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1650,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_439,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_166 || _loc12_ == RoomPlaneData.const_336)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
