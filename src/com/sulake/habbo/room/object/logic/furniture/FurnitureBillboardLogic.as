         ...
         if(param1 is RoomObjectRoomAdUpdateMessage)
         {
            ...
            switch(_loc2_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1136:
                  object.getModelController().setString(RoomObjectVariableEnum.const_479,"HabboUserDefinedRoomEventsCom_move_vrt_png");
                  _loc3_ = true;
                  break;
               case RoomObjectRoomAdUpdateMessage.const_1150:
                  object.getModelController().setString(RoomObjectVariableEnum.const_479,"error");
                  Logger.log("failed to load billboard image from url " + object.getModelController().getString(RoomObjectVariableEnum.const_652));
            }
            if(_loc3_)
            {
               object.setDirty();
         ...
         if(object != null)
         {
            ...
            if(_loc1_ != null)
            {
               ...
               if(_loc2_ != null && _loc2_.length >= 2)
               {
                  _loc3_ = _loc2_[0];
                  _loc4_ = _loc2_[1];
                  object.getModelController().setString(RoomObjectVariableEnum.const_652,_loc3_);
                  object.getModelController().setString(RoomObjectVariableEnum.FURNITURE_BILLBOARD_CLICK_URL,_loc4_);
                  object.getModelController().setString(RoomObjectVariableEnum.const_479,"loading");
