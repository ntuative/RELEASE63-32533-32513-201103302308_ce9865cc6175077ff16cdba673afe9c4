package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSongDiskLogic extends FurnitureLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            _loc2_ = object.getModelController().getString(RoomObjectVariableEnum.const_302);
            _loc3_ = int(_loc2_);
            object.getModelController().setString(RoomWidgetEnum.const_583,RoomWidgetEnum.const_823 + _loc3_);
         }
      }
   }
}
