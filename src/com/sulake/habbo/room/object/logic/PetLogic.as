   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2114)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1328 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_353,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_734,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_181);
            _loc2_.setString(RoomObjectVariableEnum.const_181,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1514,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_645,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_192,_loc3_ + this.var_863);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1584;
            _loc2_.setNumber(RoomObjectVariableEnum.const_248,this.var_1584);
            _loc2_.setNumber(RoomObjectVariableEnum.const_136,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1583;
            _loc2_.setNumber(RoomObjectVariableEnum.const_136,this.var_1583);
         }
         else
         {
            this.var_863 += 45;
