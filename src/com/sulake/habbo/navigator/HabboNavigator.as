package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2929:Dictionary;
      ...
      private var var_2193:RoomThumbnailRenderer;
      
      private var var_975:GuestRoomPasswordInput;
      
      private var var_299:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2193 = new RoomThumbnailRenderer(this);
         this.var_975 = new GuestRoomPasswordInput(this);
         this.var_299 = new GuestRoomDoorbell(this);
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_298.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_298.startSearch(Tabs.const_270,Tabs.const_405,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_298.startSearch(Tabs.const_320,Tabs.const_226);
         this.var_436.getTab(Tabs.const_320).tabPageDecorator.tabSelected();
      }
