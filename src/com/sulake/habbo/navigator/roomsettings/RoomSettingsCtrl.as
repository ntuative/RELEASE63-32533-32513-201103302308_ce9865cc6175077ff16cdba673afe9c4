package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1180:TextFieldManager;
      
      private var var_1182:ICheckBoxWindow;
      
      private var var_1188:ICheckBoxWindow;
      
      private var var_1187:ICheckBoxWindow;
      
      private var var_650:ICheckBoxWindow;
      ...
      private var var_2639:ITextWindow;
      
      private var var_2640:ITextWindow;
      ...
      {
         if(param1 != this.var_370 || this.var_1183 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1494)
         {
            this.var_783.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1721)
         {
            this.var_1186.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1695)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1460)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1621)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_554,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_864,this.onDoorModePasswordUnselect);
         ...
         this.var_1186 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_908 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_909 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_975 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1180 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1182 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1188 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1187 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_650 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1856 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1472 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1184 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1181 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1857 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1471 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_264 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1185 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2639 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2640 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1473 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1473.mouseThreshold = 0;
         this.var_1473.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1185.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1856.visible = this._inRoom;
         this.var_1857.visible = this._inRoom;
         this.var_2640.visible = this.var_523;
         this.var_2639.visible = !this.var_523;
         if(this.var_523)
         {
         ...
         else
         {
            ...
            this.var_1472.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1472.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1184.height = Util.getLowestPoint(this.var_1184) + 4;
         }
         this.var_1473.text = !!this.var_523 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1856.name,this.var_1472.name,this.var_1184.name,this.var_1181.name,this.var_1471.name,this.var_1857.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1186.setText(_loc1_.description);
         this.var_975.setText("");
         this.var_1180.setText("");
         ...
         this.setTag(this.var_908,_loc1_.tags[0]);
         this.setTag(this.var_909,_loc1_.tags[1]);
         if(this.var_1182)
         {
            if(_loc1_.allowPets)
            {
               this.var_1182.select();
            }
            else
            {
               this.var_1182.unselect();
            }
         }
         if(this.var_1188)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1186.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_442;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_112)
         {
            _loc8_ = this.var_975.getText();
            _loc9_ = this.var_1180.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_975.clearErrors();
               this.var_1180.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1182.isSelected;
         _loc2_.allowFoodConsume = this.var_1188.isSelected;
         _loc2_.allowWalkThrough = this.var_1187.isSelected;
         _loc2_.hideWalls = this.var_650.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_908,_loc2_.tags);
         this.addTag(this.var_909,_loc2_.tags);
         this.clearErrors();
         this.var_1183 = _loc2_.roomId;
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_264.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_264.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_264.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_264.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_264.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_264.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_264.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_264);
         this.var_264.findChildByName("ruler").visible = true;
         ...
         if(this.var_77.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_264,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_65,HabboWindowStyle.const_32,HabboWindowParam.const_60,new Rectangle(0,0,100,20)));
      }
