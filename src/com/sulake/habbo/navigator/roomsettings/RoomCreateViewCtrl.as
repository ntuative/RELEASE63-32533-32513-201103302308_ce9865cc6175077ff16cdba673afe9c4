package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_582 = new Timer(100);
         this.var_582.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_43 = new Array();
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,104,"a"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,94,"b"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,36,"c"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,84,"d"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"e"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"f"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,416,"i"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,320,"j"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,448,"k"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,352,"l"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,384,"m"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_53,372,"n"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,80,"g"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,74,"h"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,416,"o"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,352,"p"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,304,"q"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,336,"r"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,748,"u"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,438,"v"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_45,540,"t"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_45,512,"w"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_45,396,"x"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_45,440,"y"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_45,456,"z"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_45,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_582)
         {
            this.var_582.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_582.reset();
            this.var_582 = null;
         }
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1627 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1627 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1083 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_178.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_65,HabboWindowStyle.const_32,HabboWindowParam.const_60,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1083.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1083.getText();
         var _loc3_:String = "model_" + this.var_1082.name;
