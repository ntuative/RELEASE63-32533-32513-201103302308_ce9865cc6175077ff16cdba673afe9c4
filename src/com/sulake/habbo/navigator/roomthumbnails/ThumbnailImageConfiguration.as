package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_1909:Rectangle;
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1909 == null)
         {
            ...
            this.var_1909 = new Rectangle(this.var_1493,this.var_1493,_loc1_.width - 2 * this.var_1493,_loc1_.height - 2 * this.var_1493);
         }
         this.var_661.bitmap.fillRect(this.var_661.bitmap.rect,4281545523);
         this.var_661.bitmap.fillRect(this.var_1909,4284900966);
         this.copyTo(this.var_661.bitmap);
         if(this._selected)
         {
            this.var_661.bitmap.copyPixels(this.var_1908,this.var_1908.rect,new Point(0,0),null,null,true);
         }
