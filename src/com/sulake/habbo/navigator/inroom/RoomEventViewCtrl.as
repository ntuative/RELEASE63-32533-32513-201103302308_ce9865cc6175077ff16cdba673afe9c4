package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1705:ITextWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_736.setText(param1.eventDescription);
         this.var_908.setText(this.getTagFromEvent(param1,1));
         this.var_909.setText(this.getTagFromEvent(param1,2));
         this.var_1396.visible = false;
         this.var_1398.visible = true;
         this.var_1397.visible = true;
         this.var_1706.visible = false;
         this.var_1705.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_907.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_736.getText();
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_736.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1704 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2317 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1706 = ITextWindow(this.find("create_caption"));
            this.var_1705 = ITextWindow(this.find("edit_caption"));
            this.var_1396 = IButtonWindow(this.find("create_button"));
            this.var_1398 = IButtonWindow(this.find("edit_button"));
            this.var_2318 = IButtonWindow(this.find("cancel_button"));
            this.var_1397 = IButtonWindow(this.find("end_button"));
            this.var_907 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1396,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1398,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1397,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2318,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_736 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
            this.var_908 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_909 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
