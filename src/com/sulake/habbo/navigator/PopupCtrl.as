package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_443 = new Timer(500,1);
         this.var_366 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1056 = param4;
         this.var_2564 = param2;
         this._popupIndentLeft = param3;
         this.var_443.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_443)
         {
            this.var_443.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_443.reset();
            this.var_443 = null;
         }
         if(this.var_366)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_56 == null)
         {
            this.var_56 = IWindowContainer(this._navigator.getXmlWindow(this.var_1056));
         ...
         this.var_56.x = _loc2_.x + this.var_2564 + param1.width;
