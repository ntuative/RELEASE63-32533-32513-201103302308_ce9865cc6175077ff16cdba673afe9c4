package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2193 = new RoomThumbnailRenderer(param1);
         this.var_1198 = new TagRenderer(param1,hideInstantly);
      }
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1198.refreshTags(_loc1_,this.var_112.tags);
         ...
         this.var_2193.refreshThumbnail(_loc1_,this.var_112.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_270,Tabs.const_266,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
