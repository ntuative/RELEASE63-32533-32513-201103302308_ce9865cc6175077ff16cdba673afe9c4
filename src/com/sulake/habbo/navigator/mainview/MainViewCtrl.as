package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_639:int = 2;
      
      private static const const_1018:int = 3;
      
      private static const const_1416:int = 4;
      ...
      private var var_1013:PopularTagsListCtrl;
      
      private var var_1014:GuestRoomListCtrl;
      ...
      private var var_1254:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1013 = new PopularTagsListCtrl(this._navigator);
         this.var_1014 = new GuestRoomListCtrl(this._navigator);
         this.var_1252 = new OfficialRoomListCtrl(this._navigator);
         this.var_502 = new Timer(300,1);
         this.var_502.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_502)
            {
               this.var_502.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_502.reset();
               this.var_502 = null;
            }
            if(this.var_1013)
      ...
      private function prepare() : void
      {
         ...
         this.var_267 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         if(!this.var_267)
         {
         ...
         this.var_209 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_278 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1525 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1254 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1254)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1254.procedure = this.onHotelView;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1555,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_178,["custom_content","list_content"],this.var_232.y,8);
         this.var_209.height = this.var_209.height + _loc1_ - this.var_209.y - this.var_278.height + this.var_2761;
         Util.moveChildrenToColumn(this.var_178,["list_content","custom_footer"],this.var_209.y,0);
         this.var_2761 = this.var_278.height;
      ...
      {
         this.refreshList(param1,param2,this.var_1014,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1013,"popular_tags");
      }
      ...
      private function getSearchMsg(param1:int, param2:String) : IMessageComposer
      {
         ...
         if(param1 == Tabs.const_849)
         {
            return new RoomsWhereMyFriendsAreSearchMessageComposer();
         }
         if(param1 == Tabs.const_881)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_670 == const_1017)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_209.blend - _loc2_));
            this.var_209.blend = _loc3_;
            this.var_232.blend = !!this.var_1253 ? Number(_loc3_) : Number(1);
            this.var_278.blend = !!this.var_1253 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_670 = const_639;
            }
         }
         else if(this.var_670 == const_639)
         {
            ...
            {
               this.var_670 = const_1018;
            }
         }
         else if(this.var_670 == const_1018)
         {
            this.refresh();
            this.var_670 = const_1416;
         }
         else
         {
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.refreshScrollbar(this.var_1014);
      }
      ...
      {
         this._navigator.refreshButton(this.var_1254,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1254,"icon_hotelview_reactive",param1,null,0);
      }
