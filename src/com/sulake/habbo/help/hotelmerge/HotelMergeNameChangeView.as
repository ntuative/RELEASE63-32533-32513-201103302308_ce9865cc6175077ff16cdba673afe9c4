package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_724)
         {
            this.var_724 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_724)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_725)
         {
            this.var_725 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_725)
            {
               return;
            }
