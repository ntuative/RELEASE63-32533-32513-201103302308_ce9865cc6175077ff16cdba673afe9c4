package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_701:FaqCategory;
      
      private var var_700:FaqCategory;
      ...
      {
         super();
         this.var_701 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_700 = new FaqCategory(-9999,"${help.faq.title.normal}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_701.hasItem(param1))
         {
            this.var_701.getItem(param1).answerText = param2;
         }
         if(this.var_700.hasItem(param1))
         {
            this.var_700.getItem(param1).answerText = param2;
         }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_701.hasItem(param1))
         {
            return this.var_701.getItem(param1);
         }
         if(this.var_700.hasItem(param1))
         {
            return this.var_700.getItem(param1);
         }
         if(this.var_702.hasItem(param1))
         {
