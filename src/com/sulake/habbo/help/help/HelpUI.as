package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103302303));
         this.var_187 = param5;
         this.var_114 = new Map();
         this.var_114.add(HabboHelpViewEnum.const_1558,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_206,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_552,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_289,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_239,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_379,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_750,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_220,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_114.add(HabboHelpViewEnum.const_1181,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_114.add(HabboHelpViewEnum.const_1179,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_699,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_494.length == 0 || param1 != this.var_351)
            {
               this.var_494.push(this.var_351);
            }
         }
         this.var_351 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1149:
               this.showUI(HabboHelpViewEnum.const_1179);
               break;
            case CallForHelpResultEnum.const_1208:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_114.getValue(HabboHelpViewEnum.const_206) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_510));
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2277 = this._window.width - _loc3_.width;
         this.var_2276 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2276;
         this._window.width = _loc1_.width + this.var_2277;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_494.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_351 == HabboHelpViewEnum.const_206)
         {
            return;
         }
         if(this.var_593.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_593.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_593.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_352.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_593[1],this.var_593[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_593[0],this.var_593[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_351 == HabboHelpViewEnum.const_206 || this.var_494.length == 0)
         {
            return;
         }
         if(this.var_352 == null)
         {
            ...
            this.var_352 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_352.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_352.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_352 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_352 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_352 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
