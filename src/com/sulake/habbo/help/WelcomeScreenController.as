package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1456];
      }
      
      public function dispose() : void
      {
         this.var_134.removeUpdateReceiver(this);
         if(this.var_134)
         {
            this.var_134.toolbar.events.removeEventListener(HabboToolbarEvent.const_39,this.onToolbarClicked);
            this.var_134.toolbar.events.removeEventListener(HabboToolbarEvent.const_904,this.method_5);
            this.var_134 = null;
         }
         ...
         {
            this.var_773.stop();
            this.var_773.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_773 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_134.toolbar.events.addEventListener(HabboToolbarEvent.const_39,this.onToolbarClicked);
         this.var_134.toolbar.events.addEventListener(HabboToolbarEvent.const_904,this.method_5);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_773 = new Timer(_loc4_);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_342.y = this.var_134.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
      ...
      {
         var _loc1_:XmlAsset = this.var_134.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_134.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_90,this.current.targetIconId);
         _loc2_.iconState = !!param1 ? "highlight_blue" : "0";
         this.var_134.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      private function method_5(param1:HabboToolbarEvent) : void
      {
         if(!this._window)
         {
            return;
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1456 < this._notifications.length - 1)
         {
            ++this.var_1456;
         }
         else
      ...
      {
         this.var_134.removeUpdateReceiver(this);
         this.var_134.registerUpdateReceiver(this,10);
      }
   }
}
