package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1371:uint = 13232628;
      
      private static var var_1666:uint = 11129827;
      ...
      private var var_1096:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_308;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_492 = param1;
         if(this.var_1664 == this.var_492)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1665 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_724)
         {
            this.var_724 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_724)
            {
               return;
            }
            this._window.content.addChild(this.var_724);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_725)
         {
            this.var_725 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_725)
            {
               return;
            }
            this._window.content.addChild(this.var_725);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_725.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_492;
         }
         this.showView(this.var_725);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_492);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1047 || param1 == ChangeUserNameResultMessageEvent.var_1049)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1096 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1096.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1371;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_492 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_492);
               break;
