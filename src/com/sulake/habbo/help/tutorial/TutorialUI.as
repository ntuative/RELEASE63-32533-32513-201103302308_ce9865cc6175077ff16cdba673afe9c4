package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      private var var_398:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_518,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_454,this.onTaskDoneEvent);
         if(this.var_35.sessionDataManager != null)
         {
            this.var_35.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_337,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1292 && this.var_1293 && this.var_1566;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            ...
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_518,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_454,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
               this.var_35.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_337,this.onFigureUpdate);
            }
            this.var_35 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_518:
               if(this.var_44 != null && this.var_44.id == const_369)
               {
                  this.var_2041 = true;
                  this.disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_454:
               if(this.var_2041)
               {
                  this.var_2041 = false;
                  this.showView(const_94);
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2277 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_308:
               ...
               if(this.var_398 == null)
               {
                  this.var_398 = new NameChangeView(this);
               }
               this.var_398.showMainView();
               this.prepareForTutorial();
               break;
            case const_369:
         ...
         this._window.height = _loc2_.height + this.var_2276;
         this._window.width = _loc2_.width + this.var_2277;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_35.hideUI();
         this.var_35.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_117));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_44 != null && (this.var_44.id == const_308 || this.var_44.id == const_94))
         {
            this.showView(const_94);
         }
      }
      ...
      {
         this.var_1292 = true;
         if(this.var_44 != null && (this.var_44.id == const_369 || this.var_44.id == const_94))
         {
            this.showView(const_94);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_398.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_560)
         {
            this.var_398.checkedName = _loc2_.name;
         }
         else
         {
            this.var_398.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
