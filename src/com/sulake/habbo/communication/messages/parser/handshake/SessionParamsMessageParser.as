package com.sulake.habbo.communication.messages.parser.handshake
{
   ...
   public class SessionParamsMessageParser implements IMessageParser
   {
      ...
      protected var var_2092:Boolean;
      
      protected var var_2091:Boolean;
      
      protected var var_2731:String;
      
      protected var var_2090:Boolean;
      
      protected var var_2093:Boolean;
      ...
      protected var var_2859:Boolean;
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            switch(_loc4_)
            {
               case 0:
                  ...
                  this.var_2092 = _loc5_ > 0;
                  break;
               case 1:
                  _loc5_ = param1.readInteger();
                  this.var_2091 = _loc5_ > 0;
                  break;
               case 2:
                  _loc5_ = param1.readInteger();
                  this.var_2090 = _loc5_ > 0;
                  break;
               case 3:
                  _loc5_ = param1.readInteger();
