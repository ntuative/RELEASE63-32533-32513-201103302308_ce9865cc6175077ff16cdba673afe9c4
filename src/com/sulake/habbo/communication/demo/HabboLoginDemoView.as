package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_565:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_163.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_157,HabboWindowStyle.const_43,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1764,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_163.habboConfiguration.getKey("use.sso","false") == "HabboUserDefinedRoomEventsCom_move_vrt_png")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1764,"/");
         ...
         {
            dispatchEvent(new Event(const_565));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_136.removeEventListener(SSOTicket.const_419,this.onParsedTicketSuccess);
            this.var_136.removeEventListener(SSOTicket.const_303,this.onParsedTicketFailure);
            this.var_136 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_136.addEventListener(SSOTicket.const_419,this.onParsedTicketSuccess);
         this.var_136.addEventListener(SSOTicket.const_303,this.onParsedTicketFailure);
      }
