package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_217:HabboHotelView;
      
      private var var_1407:String = "";
      
      private const const_1764:String = "fuselogin";
      ...
      {
         if(this.var_55 && this.var_158 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_217 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_217.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_158.getKey("use.sso.ticket") == "1";
         this.var_609 = this.var_158.getKey("sso.ticket",null);
         this.var_1723 = this.var_158.getKey("flash.client.url","");
         this.var_2383 = this.var_158.getKey("external.variables.txt","");
         if(this.var_217 == null)
         {
            this.var_217 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_565,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_55.mode = HabboConnectionType.const_1201;
            }
         }
         this.var_55.initConnection(HabboConnectionType.const_244);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2385 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_55.mode)
         {
            case HabboConnectionType.const_89:
               ...
               this.var_1407 = _loc4_;
               this.var_217.loadBannerImage(_loc7_ + "?token=" + this.var_1407,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1201:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1512:
               this.var_915 = this.generateRandomHexString(30);
               ...
               this.var_503.init(this.var_915);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2385);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1723,this.var_2383));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1764,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1406)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_178);
         }
         if(param1.type == Event.CLOSE && !this.var_2384)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1407);
