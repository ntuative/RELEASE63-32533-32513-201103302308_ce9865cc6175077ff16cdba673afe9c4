package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_605.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_605.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_196);
         _loc1_.push(RoomWidgetFurniActionMessage.const_491);
         _loc1_.push(RoomWidgetFurniActionMessage.const_529);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_684);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_829);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1577);
         _loc1_.push(RoomWidgetPetCommandMessage.const_469);
         _loc1_.push(RoomWidgetPetCommandMessage.const_936);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_527)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_360 || param1.type == RoomWidgetUserActionMessage.const_475 || param1.type == RoomWidgetUserActionMessage.const_441)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_795:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1237,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_360:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_684:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_829:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_324);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetEnum.const_583) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetEnum.const_583);
               }
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1241);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1087);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_187)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc13_.webID);
                  return null;
               }
               if(_loc13_.type == RoomObjectTypeEnum.const_174)
               {
                  _loc14_ = "null";
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_860)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc19_ != null)
               {
                  _loc15_.carryItem = _loc19_.getModel().getNumber(RoomObjectVariableEnum.const_472);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_119)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_139)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     _loc33_ = _loc19_.getModel().getString(RoomObjectVariableEnum.const_655);
                  ...
                  if(!_loc29_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1042;
                  }
                  if(!_loc30_)
                  {
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1649);
               }
               else
               {
               ...
               _loc21_ = _loc13_.sex;
               _loc22_ = this._container.avatarRenderManager.createAvatarImage(_loc20_,AvatarScaleType.const_57,_loc21_);
               if(_loc22_ != null)
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_605.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_605.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_655);
