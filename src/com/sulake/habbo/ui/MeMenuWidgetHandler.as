package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this._inventory != null)
            {
               ...
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_689,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_187 != null)
            {
               this.var_187.events.removeEventListener(HabboToolbarEvent.const_73,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_512,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            ...
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_689,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_512,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1527)
            {
               ...
               this.var_1962 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1962;
            }
         }
         if(this.var_187 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1160,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_751);
         ...
         _loc1_.push(RoomWidgetSelectEffectMessage.const_850);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_897);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_673);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_381);
         _loc1_.push(RoomWidgetStopEffectMessage.const_678);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1481);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1060);
         _loc1_.push(RoomWidgetToolbarMessage.const_810);
         _loc1_.push(RoomWidgetToolbarMessage.const_753);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_350);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1692);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1240);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_668);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_918);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_709);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1610);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_867);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_749);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_876);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_378);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_918:
               ...
               break;
            case RoomWidgetWaveMessage.const_751:
            ...
            case RoomWidgetSelectEffectMessage.const_717:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_850:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_381:
               ...
               break;
            case RoomWidgetOpenInventoryMessage.const_673:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1125:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1134:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_328);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1560:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_897:
            case RoomWidgetStopEffectMessage.const_678:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1054:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1486:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_1060:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_668:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_810:
               ...
               break;
            case RoomWidgetToolbarMessage.const_753:
               ...
               {
                  this.var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_443,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            ...
            case RoomWidgetStoreSettingsMessage.const_749:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_393,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_876:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_454));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_378:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_906));
      }
