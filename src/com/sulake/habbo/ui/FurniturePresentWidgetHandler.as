package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_783,RoomWidgetPresentOpenMessage.const_169];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_783:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc8_ = _loc5_.getString(RoomObjectVariableEnum.const_302);
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_74:
                           if(_loc3_ != null && _loc3_.name == const_212)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_570,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1364)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_312:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_474,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
