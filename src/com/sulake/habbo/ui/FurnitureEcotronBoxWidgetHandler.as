package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_816,RoomWidgetEcotronBoxOpenMessage.const_696,RoomWidgetEcotronBoxOpenedMessage.const_1659];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_816:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_696:
