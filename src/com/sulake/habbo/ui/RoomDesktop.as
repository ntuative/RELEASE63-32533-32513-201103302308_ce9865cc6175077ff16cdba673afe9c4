package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1419:int = 1000;
      ...
      private var var_1256:IRoomWidgetFactory = null;
      ...
      private var var_1092:IHabboHelp = null;
      ...
      private var var_2765:uint = 16777215;
      ...
      private var var_1967:Rectangle;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_592,this.onRoomContentLoaded);
      ...
      {
         this.var_187 = param1;
         this.var_187.events.addEventListener(HabboToolbarEvent.const_503,this.onToolbarRepositionEvent);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         {
            this.var_210.toolbarSize = this.var_187.size;
            this.var_210.toolbarOrientation = this.var_187.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_817.length)
            {
               _loc6_ = this.var_817.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_592,this.onRoomContentLoaded);
         ...
         {
            this.var_187.events.removeEventListener(HabboToolbarEvent.const_503,this.onToolbarRepositionEvent);
            this.var_187.events.removeEventListener(HabboToolbarEvent.const_39,this.onHabboToolbarEvent);
         }
         this.var_187 = null;
         ...
         {
            this.var_502.reset();
            this.var_502.removeEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
            this.var_502 = null;
         }
         this.var_1967 = null;
      }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_31 != null)
         {
            this.var_816 = this._roomEngine.loadRoomResources(this.var_31.roomResources);
         ...
         if(this.var_329 != null && this.var_31.state == RoomSessionEvent.const_253)
         {
            this.var_1966 = !this.var_329.showInterstitial();
         }
      ...
      {
         if(this.var_816 == null || this.var_816.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_816.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_816.splice(_loc2_,1);
         }
         if(this.var_816.length == 0)
         {
            this.var_1964 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1256.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            if(!this.var_817.add(param1,_loc4_))
            {
               _loc4_.dispose();
            }
            _loc6_ = null;
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_818.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_818.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_819.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_819.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc4_);
               }
            }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_818.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_747:
               ...
               if(this.var_1028 != null && _loc3_ == RoomObjectCategoryEnum.const_34)
               {
                  _loc7_ = this.var_31.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_174)
                  {
                     this.var_1028.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_374:
               ...
               break;
            case RoomEngineObjectEvent.const_934:
               switch(_loc3_)
               {
                  case RoomObjectCategoryEnum.const_28:
                  case RoomObjectCategoryEnum.const_26:
            ...
            case RoomEngineObjectEvent.const_907:
               if(!this.var_31.isRoomController && !this.var_303.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_149:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1089,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_140:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1629,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
         }
         if(_loc4_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_887);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_889);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_758);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.ROOM_MAX_Y);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_264,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2765);
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_1967 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_31.roomId,this.var_31.roomCategory,this.var_326[0],_loc2_.width,_loc2_.height);
         if(this.var_502 == null)
         {
            this.var_502 = new Timer(const_1419,1);
            this.var_502.addEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
         }
         else
         {
            this.var_502.reset();
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1967));
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1965) / 1000);
      ...
      {
         if(this.var_15 != null && this.var_31 != null && this.var_1966 && this.var_1964)
         {
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_403);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_531:
               ...
               this.var_233 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_406,WindowStyle.const_705,WindowParam.const_98) as IToolTipWindow;
               this.var_233.setParamFlag(WindowParam.const_30,false);
