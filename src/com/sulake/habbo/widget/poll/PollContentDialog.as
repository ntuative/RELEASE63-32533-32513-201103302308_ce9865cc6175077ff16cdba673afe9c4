package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1219;
         if(this.var_1219 < this.var_1000.length)
         {
            _loc1_ = this.var_1000[this.var_1219] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_1000[this.var_1219] as Dictionary;
