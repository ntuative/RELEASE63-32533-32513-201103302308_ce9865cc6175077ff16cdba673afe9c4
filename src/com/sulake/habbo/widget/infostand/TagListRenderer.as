package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2072:int = 5;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(this.var_1196 + param1.height > this.var_1197.height)
         {
            return false;
         }
         ...
         {
            this._offsetX = 0;
            this.var_1196 += param1.height + this.const_2072;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1196);
         this._offsetX += param1.width + this.const_2071;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1481 != null && this.var_1481.indexOf(param1) != -1)
         {
