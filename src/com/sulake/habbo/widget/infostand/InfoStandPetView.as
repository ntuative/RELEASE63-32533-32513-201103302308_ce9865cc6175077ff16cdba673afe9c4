package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2059:int = 16;
      
      private const const_1317:int = 4;
      
      private const const_2056:uint = 14342874;
      
      private const const_2051:uint = 3815994;
      
      private const const_2049:uint = 2085362;
      
      private const const_2057:uint = 39616;
      
      private const const_2047:uint = 10513106;
      
      private const const_2052:uint = 8734654;
      
      private const const_2053:uint = 9094430;
      
      private const const_2055:uint = 6200576;
      
      private const const_2058:String = "happiness";
      
      private const const_2054:String = "experience";
      
      private const const_2048:String = "energy";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2058,param1.nutrition,param1.nutritionMax,this.const_2057,this.const_2049);
         this.updateStateElement(this.const_2054,param1.experience,param1.experienceMax,this.const_2052,this.const_2047);
         this.updateStateElement(this.const_2048,param1.energy,param1.energyMax,this.const_2055,this.const_2053);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2050,this.const_2059,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2056);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2051);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1317,_loc7_.width - 2,_loc7_.height - 2 - this.const_1317);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1317);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_199.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_199.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_199.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_200 && this.var_200.getPetId() == this.var_548)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_485,this._widget.petData.ownerId);
