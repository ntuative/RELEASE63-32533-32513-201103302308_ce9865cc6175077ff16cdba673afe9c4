package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      {
         if(this._widget == null || this.var_199 == null)
         {
            return;
         }
         var _loc2_:IWindow = this.var_199.findChildByName("furni_details_spacer");
         if(_loc2_ != null)
         {
            _loc2_.visible = param1;
         }
         var _loc3_:IWindow = this.var_199.findChildByName("furni_details_text") as ITextWindow;
         if(_loc3_ != null)
         {
