package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_65,HabboWindowStyle.const_32,0 | 0,new Rectangle(const_1340,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_434 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1419 = _loc2_.light;
         if(this.var_434 != null)
         {
            this.var_434.setValue(this.var_1419);
         }
         this.var_495 = this.colors.indexOf(_loc2_.color);
         if(this.var_616 != null)
         {
            this.var_616.setSelectedColorIndex(this.var_495);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1418 = XML(_loc1_.content);
         return this.var_1418;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_434 != null)
         {
            this.var_434.min = this._widget.minLights[param1 - 1];
         }
      }
