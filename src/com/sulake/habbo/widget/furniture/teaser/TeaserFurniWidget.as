package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1802:int = 0;
      
      private const const_1798:int = 1;
      
      private const const_1804:int = 2;
      
      private const const_1800:int = 3;
      
      private const const_1799:int = 4;
      
      private const const_2080:int = 0;
      
      private const const_2086:int = 1;
      
      private const const_2085:int = 2;
      
      private const const_2083:int = 3;
      
      private const const_2087:int = 4;
      
      private const const_2081:int = 5;
      
      private const const_1803:String = "deco_img";
      
      private const const_1801:String = "dialog_bg";
      
      private const const_2088:String = "%campaign%_dialog_bg.png";
      
      private const const_348:String = "%campaign%_gift_package.png";
      
      private const const_2082:String = "%campaign%_gift_content.png";
      
      private const const_2084:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1529 = this.var_158.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1529 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1531.length)
         {
            _loc2_ = this.var_1531.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_158 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_550,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_847,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_667,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_550,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_550:
               _loc2_ = this.const_1802;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_667:
               ...
               this._shareId = null;
               this.var_1528 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_847:
         ...
         if(this._window && (this.var_1530 != _loc2_ || _loc3_ != this.var_193))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_193 = _loc3_;
         this.var_1530 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1530)
            {
               ...
               case this.const_1798:
                  ...
                  else if(this.var_406 == this.const_2086)
                  {
                  ...
                  else if(this.var_406 == this.const_2085)
                  {
                  ...
                  else if(this.var_406 == this.const_2083)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_406 == this.const_2087)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_193,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_406 == this.const_2081)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2088.replace("%campaign%",this.var_193);
            this.setDecoImage(_loc5_,this.const_1801);
            _loc2_ = _loc2_.replace("%campaign%",this.var_193);
            this.setDecoImage(_loc2_,this.const_1803);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_926);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1528 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1528 == 1 ? "null" : InventoryCategory.const_130);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_809,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1531.push(new ImageDownloader(this,_assets,this.var_193,this.var_1529,param1,param2));
            return;
         }
