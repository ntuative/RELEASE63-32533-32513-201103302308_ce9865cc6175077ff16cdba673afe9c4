package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2076:int = 1000;
      ...
      {
         super();
         this.var_204 = new Timer(this.const_2076);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_192.isActive)
         {
            ...
            this.var_1010.width = _loc2_ * this.var_296;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_808 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_808 == null)
            {
               return;
            }
         ...
         if(!this.var_192.isActive)
         {
            this.var_808.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_808.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_808.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            if(this.var_192.isInUse)
            {
               this.method_2("effect_hilite","memenu_fx_pause");
            }
            else
            {
               this.method_2("effect_hilite","memenu_fx_play");
            }
         ...
         if(this.var_1010 != null)
         {
            this.var_296 = this.var_1010.width;
            this.var_204.start();
            this.onUpdate();
         }
      ...
      private function method_2(param1:String, param2:String) : void
      {
