package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_167["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_167["dance_icon"] = ["dance_white","dance_color"];
         this.var_167["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_167["effects_icon"] = ["effects_white","effects_color"];
         this.var_167["badges_icon"] = ["badges_white","badges_color"];
         this.var_167["wave_icon"] = ["wave_white","wave_color"];
         this.var_167["hc_icon"] = ["_white","_color"];
         this.var_167["settings_icon"] = ["settings_white","settings_color"];
         this.var_167["credits_icon"] = ["credits_white","credits_color"];
         this.var_167["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_167[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_167[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_167[param1][1] = param4;
         }
         this.method_2(param1,param3);
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_167)
         {
            _loc6_ = this.var_167[_loc3_];
            if(!(_loc6_ == null || _loc6_.length == 0))
            {
               ...
               this.method_2(_loc3_,_loc7_,_loc8_);
            }
         }
         _loc5_ = 0;
      ...
      private function method_2(param1:String, param2:String, param3:Number = 1.0) : void
      {
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1223);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1176));
            ...
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1134));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_329);
               break;
            case "hc":
               ...
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_644);
               break;
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","false") == "HabboUserDefinedRoomEventsCom_move_vrt_png";
               if(false && _loc4_)
               {
      ...
      private function onMouseOverOrOut(param1:WindowMouseEvent) : void
      {
         ...
         _loc4_ = _loc3_ + "_icon";
         _loc5_ = this.var_167[_loc4_];
         if(_loc5_ != null)
         {
            _loc6_ = _loc7_ + _loc5_[_loc8_];
            this.method_2(_loc4_,_loc6_);
         }
      }
   }
}
