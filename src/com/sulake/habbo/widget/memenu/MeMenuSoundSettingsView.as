package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      public function updateSettings(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_956 != null)
         {
            this.var_956.setValue(this.var_542);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_709));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1797);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1798);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1799);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1796);
         }
      }
