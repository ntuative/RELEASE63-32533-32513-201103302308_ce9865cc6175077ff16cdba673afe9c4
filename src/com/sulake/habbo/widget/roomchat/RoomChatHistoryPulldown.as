package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_1022:int = 150;
      
      private static const const_1021:int = 250;
      ...
      private var var_2844:BitmapData;
      
      private var var_2042:BitmapData;
      
      private var var_2840:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_40 = param3;
         this.var_2844 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_2042 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2840 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_2043 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_2044 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2839 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2842 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_79 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_314,HabboWindowStyle.const_32,HabboWindowParam.const_60,new Rectangle(0,0,param3.width,param3.height - const_85),null,0,0) as IBitmapWrapperWindow;
         this.var_40.addChild(this.var_79);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_65,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,this.var_40.height - const_85,param3.width,const_85),null,0) as IWindowContainer;
         this.var_40.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_525,HabboWindowStyle.const_43,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_85),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_508:
               this.var_79.blend += param1 / const_1021;
               this._window.blend += param1 / const_1021;
               ...
               break;
            case const_985:
               this.var_79.blend -= param1 / const_1022;
               this._window.blend -= param1 / const_1022;
      ...
      public function set state(param1:int) : void
      {
         ...
         switch(param1)
         {
            case const_364:
               ...
               {
                  if(this._window == null || this.var_79 == null)
                  {
                     return;
                  }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_40.width - this.var_2841;
         }
         if(this.var_79 != null)
         {
            this.var_79.rectangle = this.var_40.rectangle;
            this.var_79.height -= const_85;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2843 == this._window.width)
         {
            return;
         }
         this.var_2843 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2840;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_2043;
            _loc2_.disposesBitmap = false;
            this.var_2841 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2844,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2042,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2042,_loc9_);
         ...
         this.var_79.bitmap = this.var_2842;
         this.var_79.disposesBitmap = false;
      }
