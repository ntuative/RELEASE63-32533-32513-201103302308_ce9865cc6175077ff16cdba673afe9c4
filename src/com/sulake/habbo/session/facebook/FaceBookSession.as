package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_951:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1297:String = "sendAccessTokenToServer";
      
      private static const const_1298:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1297,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1298,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_951);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_951);
         }
      }
