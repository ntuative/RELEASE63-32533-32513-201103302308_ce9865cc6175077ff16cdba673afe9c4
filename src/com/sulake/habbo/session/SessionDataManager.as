package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1877:GroupDetailsView;
      ...
      private var var_654:ProductDataParser;
      ...
      private var var_1875:UserTagManager;
      
      private var var_1482:BadgeImageManager;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_321)
         {
            this.var_321.removeEventListener(FurnitureDataParser.const_118,this.onFurnitureReady);
            this.var_321.dispose();
            this.var_321 = null;
         }
         if(this.var_654)
         {
            this.var_654.removeEventListener(ProductDataParser.const_118,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1482 = new BadgeImageManager(context.root.assets,events,this.var_183,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1875.communication = this._communication;
         this.var_1201.communication = this._communication;
         this.var_1199.communication = this._communication;
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_321)
         {
            ...
            this.var_321 = new FurnitureDataParser(this.var_527,this._wallItems,this.var_528,this._localization);
            this.var_321.addEventListener(FurnitureDataParser.const_118,this.onFurnitureReady);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2185 = _loc2_.clubLevel;
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2342 = _loc3_.respectTotal;
         this._respectLeft = _loc3_.respectLeft;
         this.var_786 = _loc3_.petRespectLeft;
         this.var_671 = _loc3_.figure;
         this.var_1017 = _loc3_.sex;
         this.var_1662 = _loc3_.realName;
         this.var_2344 = _loc3_.identityId;
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_671 = _loc2_.figure;
            this.var_1017 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_671,this.var_1017));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2662 = _loc2_.isOpen;
         this.var_2663 = _loc2_.onShutDown;
      }
      ...
      {
         return this._securityLevel >= SecurityLevelEnum.const_1099;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1875.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1482.getBadgeImage(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1877 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1201.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1877.showGroupDetails(param1);
         }
      }
      ...
      {
         return this.var_1482.getBadgeImage(param1,BadgeImageManager.const_1137);
      }
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_786 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_786 = this.var_786 - 1;
      }
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_654 == null)
         {
            ...
            this.var_654 = new ProductDataParser(_loc2_,this.var_1291);
            this.var_654.addEventListener(ProductDataParser.const_118,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         {
            if(this.var_981.indexOf(param1) == -1)
            {
