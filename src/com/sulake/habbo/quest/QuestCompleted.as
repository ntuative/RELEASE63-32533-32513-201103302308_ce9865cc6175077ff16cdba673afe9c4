package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      {
         this.var_181 = IFrameWindow(this.var_64.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         ...
         this.var_181.findChildByName("description_txt").caption = this.var_64.controller.questEngine.localization.getKey(_loc5_);
         ...
         this.var_181.findChildByName("reward_txt").caption = this.var_64.controller.questEngine.localization.getKey(_loc6_);
      ...
      private function onRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(!this.var_753 && this.var_181 && _loc2_)
         {
