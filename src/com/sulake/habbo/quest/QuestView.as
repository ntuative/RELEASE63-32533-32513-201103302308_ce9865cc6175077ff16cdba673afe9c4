package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_2436:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_61.type)
         {
            ...
            case QuestTypeEnum.STACK_ITEM:
               ...
               this.var_2436 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
      ...
      private function localize() : void
      {
         ...
         {
            this.var_511 = -1;
            QuestUtils.method_2(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         ...
         if(_loc33_)
         {
            this.var_622 = new Timer(20,1);
            this.var_622.addEventListener(TimerEvent.TIMER,this.onShowReward);
            this.var_622.start();
      ...
      private function setText(param1:String, param2:String, param3:Boolean = true, param4:Boolean = false) : void
      {
         ...
         if(_loc5_)
         {
            ...
            if(param4 && _loc5_ is IHTMLTextWindow)
            {
               ...
               (_loc5_ as IHTMLTextWindow).linkTarget = LinkTarget.const_884;
            }
         }
      }
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_511 == param1)
         {
            ...
            if(_loc3_)
            {
               ...
               QuestUtils.method_2(_loc3_,param2,_loc3_.height);
               this.updateMargins();
            }
         }
      }
