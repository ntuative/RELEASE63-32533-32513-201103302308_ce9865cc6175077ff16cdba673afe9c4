package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1509:uint = 7645971;
      
      private var var_1930:uint = 6710886;
      
      private var var_199:IWindow;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1685 = param1.roomItemTypeName;
         this.var_1686 = param1.rewardCurrencyAmount;
         this.var_1931 = new Date();
         this.var_1931.setTime(param1.endDateTimeStamp);
         this.var_730 = param1.localizationCode;
         this.var_2273 = param1.questBadgeAchievementTypeId;
         this.updateView();
      }
      ...
      private function createView() : void
      {
         switch(this.var_406)
         {
            case QuestStatusEnum.const_47:
               ...
               break;
            case QuestStatusEnum.const_413:
         ...
         if(_loc1_ != null)
         {
            this.var_1509 = _loc1_.color;
         }
         var _loc2_:IWindow = this._view.findChildByTag("SELECTION_BORDER");
         if(_loc2_ != null)
         {
            this.var_1930 = _loc2_.color;
            this.var_199 = _loc2_;
         }
         else
         {
            this.var_199 = this._view;
         }
         this.var_199.color = this.var_1509;
      }
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_64.code,this.var_730].join("_");
      ...
      private function itemGridEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this._selected)
            {
               this.var_199.color = this.var_1930;
            }
         }
