package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_1171:IRegionWindow;
      
      private var var_134:QuestHelp;
      ...
      public function QuestCampaign(param1:QuestController, param2:String)
      {
         ...
         this.var_134 = new QuestHelp(this);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1467.findChildByName("currency.amount").caption = "${quest_" + this.var_1846 + ".currency}";
         var _loc3_:String = "quest_" + this.code;
         var _loc4_:* = _loc3_ + ".title";
         var _loc5_:* = _loc3_ + ".currency";
         this.setText("currency.amount",_loc5_);
         this.var_778 = this._window.findChildByName("help.button") as IWindowContainer;
         this.var_1171 = this._window.findChildByName("help.container") as IRegionWindow;
         if(this.var_1171)
         {
         ...
         if(this.var_778)
         {
            this.var_778.color = 14737632;
         }
      }
      
      public function attachTo(param1:IWindowContainer) : void
      {
         if(this.var_753 || !this._window)
         {
            return;
         }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_519)
         {
            this.var_519.selected = false;
         }
         if(this.var_134)
         {
            this.var_164.addChild(this.var_134.view);
         }
         if(this.var_164)
         {
            this.var_164.height = this._window.height - this.var_164.y * 2;
            if(this.var_134.view)
            {
               this.var_134.view.height = this.var_164.height;
            }
         }
      }
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_316.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_316)
         {
            this.var_317.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_47 || _loc4_.status == QuestStatusEnum.const_413))
            {
               _loc3_ = _loc4_;
            }
         }
         ...
         else if(this.var_316.length > 0)
         {
            this.activateListItem(this.var_316[0]);
         }
      }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_519 = param1;
         this.var_519.selected = true;
         this.showQuestData(this.var_519);
      }
