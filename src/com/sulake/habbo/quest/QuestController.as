package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private var var_58:HabboQuestEngine;
      ...
      public function questAccepted(param1:String, param2:QuestMessageData) : void
      {
         ...
         if(this.var_141 != null && this.var_141.quest.id == param2.id)
         {
      ...
      public function questCompleted(param1:String, param2:QuestMessageData) : void
      {
         ...
         if(this.var_141 != null && this.var_141.quest.id == param2.id && this.var_101 != null)
         {
      ...
      public function activateQuest(param1:Quest) : void
      {
         if(param1)
         {
            this.var_58.communication.getHabboMainConnection(null).send(new ActivateQuestMessageComposer(param1.id));
         }
      }
      ...
      public function openCampaign(param1:String, param2:int, param3:Array, param4:Boolean) : void
      {
         ...
         if(this.var_583 != MODE_TABS)
         {
            this.var_583 = MODE_NO_TABS;
         }
         this.detachCampaign();
         _loc5_ = this.var_108[param1];
         if(!_loc5_)
      ...
      private function attachCampaign() : void
      {
         ...
         this._selectedCampaign.attachTo(this.var_1222);
      ...
      private function updateTabs() : void
      {
         ...
         if(_loc1_ != "")
         {
            ...
            if(_loc3_)
            {
               ...
               {
                  this.var_58.getQuestCampaign(_loc1_);
               }
            }
         }
      }
      ...
      {
         if(this.var_58.defaultCampaignCode.length > 0)
         {
            return this.var_58.defaultCampaignCode;
         }
      ...
      private function prepareWindow(param1:Boolean) : void
      {
         ...
         this._window = IFrameWindow(this.var_58.getXmlWindow(_loc2_));
         this._window.findChildByTag("close").procedure = this.onWindowClose;
         this._window.center();
         this.var_1222 = this._window.findChildByName("content") as IWindowContainer;
      }
      
      public function initializeReminderTimer() : void
      {
         if(this.var_58.configuration.getKey("questing.reminder.enabled","") != "HabboUserDefinedRoomEventsCom_move_vrt_png")
         {
         ...
         this.var_773 = new Timer(_loc1_ * 1000);
         this.var_773.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         {
            this.var_1915 = true;
            this.var_58.getQuestCampaign(_loc2_);
            return;
         }
      ...
      private function method_6() : Boolean
      {
         ...
         while(_loc1_ <= 2)
         {
            _loc2_ = this.var_58.windowManager.getDesktop(_loc1_);
      ...
      private function showQuestReminder(param1:QuestCampaign, param2:Quest) : void
      {
         ...
         if(this.var_101 != null)
         {
            _loc3_ = this.var_101.rectangle;
            this.var_101.dispose();
            this.var_101 = null;
         }
         this.var_101 = IWindowContainer(this.var_58.getXmlWindow("QuestReminder"));
         this.var_101.findChildByTag("close").procedure = this.onReminderWindowClose;
         if(_loc3_ != null)
         {
            this.var_101.x = _loc3_.x;
            this.var_101.y = _loc3_.y;
         }
         else
         {
            this.var_101.center();
         }
         var _loc4_:IWindowContainer = IWindowContainer(this.var_101.findChildByName("quest.container"));
         ...
         this.var_141 = new QuestView(param1,param2,true);
         _loc4_.addChild(this.var_141.view);
         this.var_141.init();
         this.var_101.height = param2.type == "FIND_STUFF" ? 453 : 390;
         this.var_101.visible = true;
         this.var_101.activate();
      }
      
      public function closeReminderOnExitRoom() : void
      {
         if(this.var_141 != null && this.var_101 != null && this.var_141.quest != null && this.var_141.quest.status != QuestStatusEnum.const_47)
         {
            this.var_101.visible = false;
         }
      }
      ...
      {
         return param1 == QuestStatusEnum.const_47 || param1 == QuestStatusEnum.const_413;
      }
      ...
      private function onReminderWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            this.var_101.visible = false;
            this.var_1500 = true;
            _loc3_ = this.var_141.quest.campaign.code + "." + this.var_141.quest.localizationCode;
            this.var_58.communication.getHabboMainConnection(null).send(new ConversionPointMessageComposer("Questing",_loc3_,"Rejected",_loc3_));
         }
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_108.getKeys())
         {
            ...
            if(!_loc2_)
            {
               ...
               _loc2_ = this.var_58.windowManager.createWindow("tab_" + _loc4_,"${" + _loc6_ + "}",WindowType.const_534) as ITabButtonWindow;
               if(_loc3_.expired)
               {
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         this.var_58.getQuestCampaign(_loc3_);
      }
   }
}
