package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class AddFriendsEntityTab extends Tab
   {
      ...
      private static const const_1807:String = "title";
      
      private static const BUTTON:String = "button";
      
      private static const const_1426:String = "addFriendsEntityTabXML";
      
      private static const const_1425:String = "friends_icon_png";
       
      
      public function AddFriendsEntityTab()
      {
         super();
         _window = var_1298.buildFromXML(var_849.getAssetByName(const_1426).content as XML) as IWindowContainer;
         _window.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMouseClick);
         var _loc1_:IBitmapWrapperWindow = _window.findChildByName(const_1328) as IBitmapWrapperWindow;
         _loc1_.disposesBitmap = false;
         _loc1_.bitmap = var_849.getAssetByName(const_1425).content as BitmapData;
