package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1020 + const_1444)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1443;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_558 == null || _loc1_.id != this.var_558.id)
         {
            this.var_558 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_558.followingAllowed)
         {
            this.var_2038.enable();
         }
         else
         {
            this.var_2038.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_558.messages.length - const_1020);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_558.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_558.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_793 || param3.type == Message.const_898 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_558.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_129.send(new FollowFriendMessageComposer(this.var_558.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_804)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1219)
         {
            return 4288269465;
         }
         return 4291611852;
