package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         this.var_911 = IWindowContainer(param2.findChildByName("conversationstab"));
      ...
      {
         return Math.floor(this.var_911.width / this.var_1110);
      }
      ...
      {
         var _loc3_:IWindowContainer = this.var_911.getChildAt(param1) as IWindowContainer;
         if(_loc3_ == null)
         {
            if(param2 == null)
            {
         ...
         _loc3_.x = param1 * this.var_1110;
         _loc3_.width = this.var_1110;
         return false;
      }
      ...
      private function refreshAsArrow(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:int = this.var_911.width % this.var_1110;
         _loc3_.width = this.var_1110 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_162 ? this.var_129.conversations.findConversation(param2.id) : this.var_129.conversations.openConversations[_loc3_ + this.var_129.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
