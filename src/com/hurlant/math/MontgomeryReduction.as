package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1813 = param1.invDigit();
         this.var_1812 = this.var_1813 & 32767;
         this.var_2532 = this.var_1813 >> 15;
         this.var_2533 = 131071;
         this.var_2534 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_159) > 0)
         {
